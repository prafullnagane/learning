...
public class PickupOrderEntryGroupPopulatorTest
{
	...
	private static final Double USER_LAT = Double.valueOf(20.0);
	private static final Double USER_LON = Double.valueOf(120.0);
	...
	public void testPopulate()
	{
		...
		given(Double.valueOf(point.getLatitude())).willReturn(USER_LAT);
		given(Double.valueOf(point.getLongitude())).willReturn(USER_LON);
