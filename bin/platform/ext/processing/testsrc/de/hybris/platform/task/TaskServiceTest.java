...
public class TaskServiceTest extends AbstractTaskTest
{
	...
	public void testEvent() throws Exception
	{
		...
		final TaskModel task2 = new TaskModel();
		task2.setRunnerBean("testTaskRunner");
		final TaskConditionModel tm = new TaskConditionModel();
	...
	public void testSchedulingErrors() throws Exception
	{
		...
		task = new TaskModel(); // create a new one just to be sure
		task.setRunnerBean("testTaskRunner");

		final TaskConditionModel cond1 = new TaskConditionModel();
		cond1.setUniqueID("foo");
		final TaskConditionModel cond2 = new TaskConditionModel();
	...
	public void testExpirationDate() throws InterruptedException
	{
		...
		TaskModel expiredTask = new TaskModel();
