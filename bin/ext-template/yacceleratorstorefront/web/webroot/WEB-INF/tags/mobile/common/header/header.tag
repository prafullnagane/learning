...
<div id="header" data-role="header" data-theme="d">
	...
	<form name="search_form" method="get" action="<c:url value="/search"/>">
		...
		<ycommerce:testId code="header_search_input">
			...
			<input id="search" class="text accmob-mainSearch-input" type="search" name="text" value="" maxlength="100" placeholder="${searchPlaceholder}" data-autocomplete-url="${autocompleteUrl}"/>
		</ycommerce:testId>
