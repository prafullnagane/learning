...
/**
 * Generated resource class for type ImpExImportCronJob first defined at extension impex
 */
@SuppressWarnings("all")
public class ImpExImportCronJobResource extends AbstractYResource<ImpExImportCronJobModel>
{
	/**
	 * <i>Generated constructor</i> - for generic creation.
	 */
	public ImpExImportCronJobResource()
	{
	 ...
	 */
	@DELETE
	public Response deleteImpExImportCronJob()
	{
	 ...
	 */
	@GET
	public Response getImpExImportCronJob()
	{
	 ...
	 */
	public ImpExImportCronJobModel getImpExImportCronJobModel()
	{
	 ...
	 */
	@PUT
	public Response putImpExImportCronJob(final ImpExImportCronJobDTO dto)
	{
		return createPutResponse(dto).build();
	}
	
	/**
	 * Gets the {@link ImpExImportCronJobModel} resource which is addressed by current resource request.
	 * @see de.hybris.platform.webservices.AbstractYResource#readResource(String)
	 */
	@Override
	protected ImpExImportCronJobModel readResource(final String resourceId) throws Exception
	{
		ImpExImportCronJobModel model = new ImpExImportCronJobModel();
		model.setCode(resourceId);
		return (ImpExImportCronJobModel) readResourceInternal(model);
	}
	
	/**
	 * Convenience method which just delegates to {@link #setResourceValue(ImpExImportCronJobModel)}
	 */
	public void setImpExImportCronJobModel(final ImpExImportCronJobModel value)
	{
