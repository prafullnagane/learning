...
public class CatalogVersionSyncScheduleMediaModel extends MediaModel
{
	 ...
	 */
	@Deprecated
	public CatalogVersionSyncScheduleMediaModel(final CatalogVersionModel _catalogVersion, final String _code)
	{
		super();
	 ...
	 */
	@Deprecated
	public CatalogVersionSyncScheduleMediaModel(final CatalogVersionModel _catalogVersion, final String _code, final MediaFolderModel _folder, final ItemModel _owner)
	{
		super();
		setCatalogVersion(_catalogVersion);
		setCode(_code);
