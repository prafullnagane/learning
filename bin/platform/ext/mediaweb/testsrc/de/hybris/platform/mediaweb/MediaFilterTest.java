...
public class MediaFilterTest
{
	...
	public void setUp() throws Exception
	{
		...
		given(httpRequest.getParameter("context")).willReturn(
				"bWFzdGVyOjo6cm9vdDo6OjEyMzQ1Ojo6aW1hZ2UvanBlZzo6OmgwMS9oMDIvZm9vLmpwZzo6OnF3ZXJ0eTEyMzQ1");
	...
	private class TestMediaFilter extends MediaFilter
	{
		...
		@Override
		protected void buildStreamAndWriteOutput(final File mediaFile, final HttpServletResponse httpResponse) throws IOException
		{
