...
/**
 * Generated resource class for type ImpExExportCronJob first defined at extension impex
 */
@SuppressWarnings("all")
public class ImpExExportCronJobResource extends AbstractYResource<ImpExExportCronJobModel>
{
	/**
	 * <i>Generated constructor</i> - for generic creation.
	 */
	public ImpExExportCronJobResource()
	{
	 ...
	 */
	@DELETE
	public Response deleteImpExExportCronJob()
	{
	 ...
	 */
	@GET
	public Response getImpExExportCronJob()
	{
	 ...
	 */
	public ImpExExportCronJobModel getImpExExportCronJobModel()
	{
	 ...
	 */
	@PUT
	public Response putImpExExportCronJob(final ImpExExportCronJobDTO dto)
	{
		return createPutResponse(dto).build();
	}
	
	/**
	 * Gets the {@link ImpExExportCronJobModel} resource which is addressed by current resource request.
	 * @see de.hybris.platform.webservices.AbstractYResource#readResource(String)
	 */
	@Override
	protected ImpExExportCronJobModel readResource(final String resourceId) throws Exception
	{
		ImpExExportCronJobModel model = new ImpExExportCronJobModel();
		model.setCode(resourceId);
		return (ImpExExportCronJobModel) readResourceInternal(model);
	}
	
	/**
	 * Convenience method which just delegates to {@link #setResourceValue(ImpExExportCronJobModel)}
	 */
	public void setImpExExportCronJobModel(final ImpExExportCronJobModel value)
	{
