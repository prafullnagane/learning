...
@GraphNode(target = AcceleratorProductBOGOFPromotionModel.class, factory = GenericNodeFactory.class, uidProperties="pk")
@XmlRootElement(name = "acceleratorproductbogofpromotion")
public class AcceleratorProductBOGOFPromotionDTO extends ProductBOGOFPromotionDTO
{
	/**
	 * <i>Generated constructor</i> - for generic creation.
	 */
	public AcceleratorProductBOGOFPromotionDTO()
	{
		super();
	}
