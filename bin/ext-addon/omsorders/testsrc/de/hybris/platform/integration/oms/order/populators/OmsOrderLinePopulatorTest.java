...
public class OmsOrderLinePopulatorTest
{
	...
	public void testOmsOrderLinePopulator() throws Exception
	{
		...
		final AbstractOrderEntryModel orderLineEntryModel = Mockito.mock(AbstractOrderEntryModel.class);
		...
		Assert.assertEquals(omsOrderLine.getUnitPrice().getValue(), orderLineEntryModel.getTotalPrice().doubleValue(), 0);
		Assert.assertEquals(omsOrderLine.getUnitTax().getValue(), 10.76D, 0);
