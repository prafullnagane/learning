...
public class AbstractOrderModel extends ItemModel
{
	...
	/** <i>Generated constant</i> - Attribute key of <code>AbstractOrder.orderRecalculationHash</code> attribute defined at extension <code>commerceservices</code>. */
	public static final String ORDERRECALCULATIONHASH = "orderRecalculationHash";
	...
	/** <i>Generated variable</i> - Variable of <code>AbstractOrder.orderRecalculationHash</code> attribute defined at extension <code>commerceservices</code>. */
	private String _orderRecalculationHash;
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>AbstractOrder.globalDiscountValues</code> attribute defined at extension <code>core</code>. 
	 * Consider using FlexibleSearchService::searchRelation for pagination support of large result sets.
	 * @return the globalDiscountValues
	 */
	public List<DiscountValue> getGlobalDiscountValues()
	{
		return _globalDiscountValues = getPersistenceContext().getValue(GLOBALDISCOUNTVALUES, _globalDiscountValues);
	}
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>AbstractOrder.orderRecalculationHash</code> attribute defined at extension <code>commerceservices</code>. 
	 * @return the orderRecalculationHash - The hash of attributes to determine if recalculation is necessary
	 */
	public String getOrderRecalculationHash()
	{
		return _orderRecalculationHash = getPersistenceContext().getValue(ORDERRECALCULATIONHASH, _orderRecalculationHash);
	}
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>AbstractOrder.totalTaxValues</code> attribute defined at extension <code>core</code>. 
	 * Consider using FlexibleSearchService::searchRelation for pagination support of large result sets.
	 * @return the totalTaxValues
	 */
	public Collection<TaxValue> getTotalTaxValues()
	{
		return _totalTaxValues = getPersistenceContext().getValue(TOTALTAXVALUES, _totalTaxValues);
	}
	 ...
	 * @return the discountsIncludeDeliveryCost - Tells whether delivery costs should be included in discount calculation or not. If this field is true delivery costs are changed the same way as product costs if discount values are set at this order.
	 */
	 ...
	 * @return the discountsIncludePaymentCost - Tells whether payment costs should be included in discount calculation or not. If this field is true payment costs are changed the same way as product costs if discount values are set at this order.
	 */
	 ...
	 *  
	 * @param value the discountsIncludeDeliveryCost - Tells whether delivery costs should be included in discount calculation or not. If this field is true delivery costs are changed the same way as product costs if discount values are set at this order.
	 */
	 ...
	 *  
	 * @param value the discountsIncludePaymentCost - Tells whether payment costs should be included in discount calculation or not. If this field is true payment costs are changed the same way as product costs if discount values are set at this order.
	 */
	...
	/**
	 * <i>Generated method</i> - Setter of <code>AbstractOrder.globalDiscountValues</code> attribute defined at extension <code>core</code>. 
	 *  
	 * @param value the globalDiscountValues
	 */
	public void setGlobalDiscountValues(final List<DiscountValue> value)
	{
		_globalDiscountValues = getPersistenceContext().setValue(GLOBALDISCOUNTVALUES, value);
	}
	...
	/**
	 * <i>Generated method</i> - Setter of <code>AbstractOrder.orderRecalculationHash</code> attribute defined at extension <code>commerceservices</code>. 
	 *  
	 * @param value the orderRecalculationHash - The hash of attributes to determine if recalculation is necessary
	 */
	public void setOrderRecalculationHash(final String value)
	{
		_orderRecalculationHash = getPersistenceContext().setValue(ORDERRECALCULATIONHASH, value);
	}
	...
	/**
	 * <i>Generated method</i> - Setter of <code>AbstractOrder.totalTaxValues</code> attribute defined at extension <code>core</code>. 
	 *  
	 * @param value the totalTaxValues
	 */
	public void setTotalTaxValues(final Collection<TaxValue> value)
	{
		_totalTaxValues = getPersistenceContext().setValue(TOTALTAXVALUES, value);
	}
