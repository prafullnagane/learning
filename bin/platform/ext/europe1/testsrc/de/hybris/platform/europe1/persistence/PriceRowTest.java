...
public class PriceRowTest extends HybrisJUnit4Test
{
	...
	public void setUp() throws Exception
	{
		...
		assertNotNull(cg = EnumerationManager.getInstance().createEnumerationValue(Europe1Constants.TYPES.DISCOUNT_USER_GROUP,
				"test"));

		assertNotNull(priceRow = europe1.createPriceRow(product, null, null, cg, 0, currency, unit, 1, true, null, 0));
	}
