...
/**
 * Generated resource class for type CronJob first defined at extension processing
 */
@SuppressWarnings("all")
public class CronJobResource extends AbstractYResource<CronJobModel>
{
	/**
	 ...
	 */
	public CronJobModel getCronJobModel()
	{
	 ...
	 */
	@POST
	public Response postCronJob(final CronJobDTO dto)
	{
	 ...
	 */
	@PUT
	public Response putCronJob(final CronJobDTO dto)
	{
		return createPutResponse(dto).build();
	}
	
	/**
	 * Gets the {@link CronJobModel} resource which is addressed by current resource request.
	 * @see de.hybris.platform.webservices.AbstractYResource#readResource(String)
	 */
	@Override
	protected CronJobModel readResource(final String resourceId) throws Exception
	{
		CronJobModel model = new CronJobModel();
		model.setCode(resourceId);
		return (CronJobModel) readResourceInternal(model);
	}
	
	/**
	 * Convenience method which just delegates to {@link #setResourceValue(CronJobModel)}
	 */
	public void setCronJobModel(final CronJobModel value)
	{
