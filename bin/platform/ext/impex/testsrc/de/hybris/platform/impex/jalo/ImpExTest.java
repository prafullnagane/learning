...
import de.hybris.platform.cronjob.jalo.SessionTimeoutJob;
...
public class ImpExTest extends AbstractImpExTest
{
	...
	public void testAbstractInsertUpdate()
	{
		...
		"INSERT Job;" + Job.CODE + "[unique=true];\n"
				...
				+ "SessionTimeoutJob;testjob2;bla\n"
				// 5. will pass
	...
	{
		final ImpExImportReader impExImportReader = new ImpExImportReader("INSERT UserGroup ; uid[unique=true] ; groups(uid) \n"
				+ "; grp100 ; \n" + "; grp110 ; grp100 \n" + "; grp120 ; grp100 \n " + "; grp111 ; grp110 \n "
				+ "; grp121 ; grp120 \n " + " \n " + "INSERT Employee ; uid[unique=true] ; groups( uid, groups( uid ) ) \n"
				+ "; thomas ; grp111:grp110, grp121:grp120 \n" + "; dummy ; grp111:grp100 \n");

		UserGroup grp100, grp110, grp120, grp111, grp121;
		Employee thomas, dummy;
		try
		{
			grp100 = (UserGroup) impExImportReader.readLine();
			grp110 = (UserGroup) impExImportReader.readLine();
			assertCollection(Collections.singleton(grp100), grp110.getGroups());
			grp120 = (UserGroup) impExImportReader.readLine();
			assertCollection(Collections.singleton(grp100), grp120.getGroups());
			grp111 = (UserGroup) impExImportReader.readLine();
			assertCollection(Collections.singleton(grp110), grp111.getGroups());
			grp121 = (UserGroup) impExImportReader.readLine();
			assertCollection(Collections.singleton(grp120), grp121.getGroups());

			thomas = (Employee) impExImportReader.readLine();
			assertEquals(0, impExImportReader.getDumpedLineCount());
			assertCollection(Arrays.asList(grp111, grp121), thomas.getGroups());

			dummy = (Employee) impExImportReader.readLine();
			assertEquals(Collections.EMPTY_SET, dummy.getGroups());
