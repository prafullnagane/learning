...
<form:form method="post" commandName="addressForm">
	...
	<ul class="mFormList">
		...
		<li>
			<formElement:formSelectBox idKey="address.region" labelKey="address.province" path="regionIso" mandatory="true" skipBlank="false" skipBlankMessageKey="address.selectProvince" items="${provinces}" itemValue="isocode" selectedValue="${addressForm.regionIso}"/>
		</li>
        ...
        <li><formElement:formInputBox idKey="address.line1" labelKey="address.street" path="line1" inputCSS="text" mandatory="true"/></li>
		<li><formElement:formInputBox idKey="address.line2" labelKey="address.building" path="line2" inputCSS="text" mandatory="false"/></li>
