...
public class ReturnOrderEntryModel extends OrderEntryModel
{
	 ...
	 */
	@Deprecated
	public ReturnOrderEntryModel(final OrderModel _order, final ProductModel _product, final Long _quantity, final UnitModel _unit)
	{
		super();
		setOrder(_order);
		setProduct(_product);
	 ...
	 */
	@Deprecated
	public ReturnOrderEntryModel(final OrderModel _order, final ItemModel _owner, final ProductModel _product, final Long _quantity, final UnitModel _unit)
	{
		super();
		setOrder(_order);
		setOwner(_owner);
