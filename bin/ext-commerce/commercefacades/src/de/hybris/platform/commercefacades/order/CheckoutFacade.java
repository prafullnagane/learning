...
public interface CheckoutFacade
{
	...
	/**
	 * Set the delivery mode on the cart
	 * Checks if the deliveryMode code is supported.
	 * If the code is not supported it does not get set and a false is returned.
	 *
	 ...
	 * @param addressId The PK of an address
	 * @param visibleAddressesOnly If true checks visible addresses in the address book
