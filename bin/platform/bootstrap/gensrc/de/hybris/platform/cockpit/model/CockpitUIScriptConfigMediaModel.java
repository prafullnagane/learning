...
public class CockpitUIScriptConfigMediaModel extends CockpitUIConfigurationMediaModel
{
	 ...
	 */
	@Deprecated
	public CockpitUIScriptConfigMediaModel(final CatalogVersionModel _catalogVersion, final String _code, final MediaFolderModel _folder, final ItemModel _owner)
	{
		super();
		setCatalogVersion(_catalogVersion);
		setCode(_code);
