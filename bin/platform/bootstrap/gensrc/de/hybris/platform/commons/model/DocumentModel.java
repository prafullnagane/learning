...
public class DocumentModel extends MediaModel
{
	 ...
	 */
	@Deprecated
	public DocumentModel(final CatalogVersionModel _catalogVersion, final String _code, final MediaFolderModel _folder, final FormatModel _format, final ItemModel _owner, final ItemModel _sourceItem)
	{
		super();
		setCatalogVersion(_catalogVersion);
		setCode(_code);
