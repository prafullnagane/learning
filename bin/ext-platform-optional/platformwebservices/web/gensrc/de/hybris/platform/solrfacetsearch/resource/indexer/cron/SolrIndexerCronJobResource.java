...
/**
 * Generated resource class for type SolrIndexerCronJob first defined at extension solrfacetsearch
 */
@SuppressWarnings("all")
public class SolrIndexerCronJobResource extends AbstractYResource<SolrIndexerCronJobModel>
{
	/**
	 * <i>Generated constructor</i> - for generic creation.
	 */
	public SolrIndexerCronJobResource()
	{
	 ...
	 */
	@DELETE
	public Response deleteSolrIndexerCronJob()
	{
	 ...
	 */
	@GET
	public Response getSolrIndexerCronJob()
	{
	 ...
	 */
	public SolrIndexerCronJobModel getSolrIndexerCronJobModel()
	{
	 ...
	 */
	@PUT
	public Response putSolrIndexerCronJob(final SolrIndexerCronJobDTO dto)
	{
		return createPutResponse(dto).build();
	}
	
	/**
	 * Gets the {@link SolrIndexerCronJobModel} resource which is addressed by current resource request.
	 * @see de.hybris.platform.webservices.AbstractYResource#readResource(String)
	 */
	@Override
	protected SolrIndexerCronJobModel readResource(final String resourceId) throws Exception
	{
		SolrIndexerCronJobModel model = new SolrIndexerCronJobModel();
		model.setCode(resourceId);
		return (SolrIndexerCronJobModel) readResourceInternal(model);
	}
	
	/**
	 * Convenience method which just delegates to {@link #setResourceValue(SolrIndexerCronJobModel)}
	 */
	public void setSolrIndexerCronJobModel(final SolrIndexerCronJobModel value)
	{
