...
/**
 * Generated resource class for type Step first defined at extension processing
 */
@SuppressWarnings("all")
public class StepResource extends AbstractYResource<StepModel>
{
	/**
	 ...
	 */
	@PUT
	public Response putStep(final StepDTO dto)
	{
		return createPutResponse(dto).build();
	}
	
	/**
	 * Gets the {@link StepModel} resource which is addressed by current resource request.
	 * @see de.hybris.platform.webservices.AbstractYResource#readResource(String)
	 */
	@Override
	protected StepModel readResource(final String resourceId) throws Exception
	{
		StepModel model = new StepModel();
		model.setCode(resourceId);
		return (StepModel) readResourceInternal(model);
	}
	
	/**
	 * Convenience method which just delegates to {@link #setResourceValue(StepModel)}
	 */
	public void setStepModel(final StepModel value)
	{
