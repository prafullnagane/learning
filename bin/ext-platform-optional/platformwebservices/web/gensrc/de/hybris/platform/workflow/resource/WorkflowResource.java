...
/**
 * Generated resource class for type Workflow first defined at extension workflow
 */
@SuppressWarnings("all")
public class WorkflowResource extends AbstractYResource<WorkflowModel>
{
	/**
	 ...
	 */
	@PUT
	public Response putWorkflow(final WorkflowDTO dto)
	{
		return createPutResponse(dto).build();
	}
	
	/**
	 * Gets the {@link WorkflowModel} resource which is addressed by current resource request.
	 * @see de.hybris.platform.webservices.AbstractYResource#readResource(String)
	 */
	@Override
	protected WorkflowModel readResource(final String resourceId) throws Exception
	{
		WorkflowModel model = new WorkflowModel();
		model.setCode(resourceId);
		return (WorkflowModel) readResourceInternal(model);
	}
	
	/**
	 * Convenience method which just delegates to {@link #setResourceValue(WorkflowModel)}
	 */
	public void setWorkflowModel(final WorkflowModel value)
	{
