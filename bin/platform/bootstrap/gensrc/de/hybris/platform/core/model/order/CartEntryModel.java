...
public class CartEntryModel extends AbstractOrderEntryModel
{
	 ...
	 * @param _order initial attribute declared by type <code>CartEntry</code> at extension <code>core</code>
	 ...
	 */
	@Deprecated
	public CartEntryModel(final CartModel _order, final ProductModel _product, final Long _quantity, final UnitModel _unit)
	{
		super();
		setOrder(_order);
		setProduct(_product);
	 ...
	 */
	@Deprecated
	public CartEntryModel(final CartModel _order, final ItemModel _owner, final ProductModel _product, final Long _quantity, final UnitModel _unit)
	{
		super();
		setOrder(_order);
		setOwner(_owner);
