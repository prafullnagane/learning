...
public class CisAvsFieldErrorPopulatorTest
{
	...
	{
		List<CisFieldError> source = new ArrayList<CisFieldError>();
		CisFieldError cisFieldError = new CisFieldError();
		cisFieldError.setField(CisField.CITY);
		cisFieldError.setErrorCode(CisFieldErrorCode.MISSING);
		source.add(cisFieldError);

		List<AddressFieldErrorData> target = new ArrayList<AddressFieldErrorData>();
