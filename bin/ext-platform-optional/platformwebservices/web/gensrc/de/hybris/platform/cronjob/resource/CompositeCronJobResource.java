...
/**
 * Generated resource class for type CompositeCronJob first defined at extension processing
 */
@SuppressWarnings("all")
public class CompositeCronJobResource extends AbstractYResource<CompositeCronJobModel>
{
	/**
	 * <i>Generated constructor</i> - for generic creation.
	 */
	public CompositeCronJobResource()
	{
	 ...
	 */
	@DELETE
	public Response deleteCompositeCronJob()
	{
	 ...
	 */
	@GET
	public Response getCompositeCronJob()
	{
	 ...
	 */
	public CompositeCronJobModel getCompositeCronJobModel()
	{
	 ...
	 */
	@PUT
	public Response putCompositeCronJob(final CompositeCronJobDTO dto)
	{
		return createPutResponse(dto).build();
	}
	
	/**
	 * Gets the {@link CompositeCronJobModel} resource which is addressed by current resource request.
	 * @see de.hybris.platform.webservices.AbstractYResource#readResource(String)
	 */
	@Override
	protected CompositeCronJobModel readResource(final String resourceId) throws Exception
	{
		CompositeCronJobModel model = new CompositeCronJobModel();
		model.setCode(resourceId);
		return (CompositeCronJobModel) readResourceInternal(model);
	}
	
	/**
	 * Convenience method which just delegates to {@link #setResourceValue(CompositeCronJobModel)}
	 */
	public void setCompositeCronJobModel(final CompositeCronJobModel value)
	{
