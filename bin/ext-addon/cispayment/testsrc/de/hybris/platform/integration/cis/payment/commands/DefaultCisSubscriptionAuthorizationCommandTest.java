...
import com.hybris.cis.client.PaymentClient;
...
public class DefaultCisSubscriptionAuthorizationCommandTest extends ServicelayerTest
{
	...
	public void shouldAuthorizeAndGetRejected() throws Exception
	{
		...
		final BillingInfo billingInfo = createBillingInfo();
		final SubscriptionAuthorizationRequest request = new SubscriptionAuthorizationRequest(String.valueOf(System.currentTimeMillis()), subscriptionResult
				.getSubscriptionInfoData().getSubscriptionID(), Currency.getInstance("USD"), BigDecimal.valueOf(1500D)  , billingInfo,
				"cisCybersource");
	...
	private CreateSubscriptionResult getCreateSubscriptionResult(final String testClientRef, final Map<String, String> profileCreationResponse)
	{
