...
/**
 * Generated resource class for type MediaProcessorStep first defined at extension processing
 */
@SuppressWarnings("all")
public class MediaProcessorStepResource extends AbstractYResource<MediaProcessorStepModel>
{
	/**
	 * <i>Generated constructor</i> - for generic creation.
	 */
	public MediaProcessorStepResource()
	{
	 ...
	 */
	@DELETE
	public Response deleteMediaProcessorStep()
	{
	 ...
	 */
	@GET
	public Response getMediaProcessorStep()
	{
	 ...
	 */
	public MediaProcessorStepModel getMediaProcessorStepModel()
	{
	 ...
	 */
	@PUT
	public Response putMediaProcessorStep(final MediaProcessorStepDTO dto)
	{
		return createPutResponse(dto).build();
	}
	
	/**
	 * Gets the {@link MediaProcessorStepModel} resource which is addressed by current resource request.
	 * @see de.hybris.platform.webservices.AbstractYResource#readResource(String)
	 */
	@Override
	protected MediaProcessorStepModel readResource(final String resourceId) throws Exception
	{
		MediaProcessorStepModel model = new MediaProcessorStepModel();
		model.setCode(resourceId);
		return (MediaProcessorStepModel) readResourceInternal(model);
	}
	
	/**
	 * Convenience method which just delegates to {@link #setResourceValue(MediaProcessorStepModel)}
	 */
	public void setMediaProcessorStepModel(final MediaProcessorStepModel value)
	{
