...
/**
 * Generated resource class for type CatalogVersionSyncJob first defined at extension catalog
 */
@SuppressWarnings("all")
public class CatalogVersionSyncJobResource extends AbstractYResource<CatalogVersionSyncJobModel>
{
	/**
	 * <i>Generated constructor</i> - for generic creation.
	 */
	public CatalogVersionSyncJobResource()
	{
	 ...
	 */
	@DELETE
	public Response deleteCatalogVersionSyncJob()
	{
	 ...
	 */
	@GET
	public Response getCatalogVersionSyncJob()
	{
	 ...
	 */
	public CatalogVersionSyncJobModel getCatalogVersionSyncJobModel()
	{
	 ...
	 */
	@PUT
	public Response putCatalogVersionSyncJob(final CatalogVersionSyncJobDTO dto)
	{
		return createPutResponse(dto).build();
	}
	
	/**
	 * Gets the {@link CatalogVersionSyncJobModel} resource which is addressed by current resource request.
	 * @see de.hybris.platform.webservices.AbstractYResource#readResource(String)
	 */
	@Override
	protected CatalogVersionSyncJobModel readResource(final String resourceId) throws Exception
	{
		CatalogVersionSyncJobModel model = new CatalogVersionSyncJobModel();
		model.setCode(resourceId);
		return (CatalogVersionSyncJobModel) readResourceInternal(model);
	}
	
	/**
	 * Convenience method which just delegates to {@link #setResourceValue(CatalogVersionSyncJobModel)}
	 */
	public void setCatalogVersionSyncJobModel(final CatalogVersionSyncJobModel value)
	{
