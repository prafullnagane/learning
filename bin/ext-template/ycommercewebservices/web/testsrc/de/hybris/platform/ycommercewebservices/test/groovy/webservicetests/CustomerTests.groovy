...
class CustomerTests extends BaseWSTest {
	...
	def createAddress(access_token, town = "Muenchen") {
		def postBody = "titleCode=${titleCode}&firstName=${firstName}&lastName=${lastName}&line1=${line1}&town=${town}&postcode=${postcode}&countryIsoCode=${countryIsoCode}"
	...
	def createPaymentInfo() {
		...
		return [uid, access_token, cookieNoPath, paymentInfoId]
	}
	...
	void testChangePassword() {
		...
		def con = TestUtil.getSecureConnection("/customers/current/password", 'POST', 'XML', HttpURLConnection.HTTP_ACCEPTED, postBody, null, access_token)
	...
	void testChangePasswordJSON() {
		...
		def postBody = "old=${password}&new=newpassword"
		def con = TestUtil.getSecureConnection("/customers/current/password", 'POST', 'JSON', HttpURLConnection.HTTP_ACCEPTED, postBody, null, access_token)
	}
	...
	void testAddressBook() {
		...
		def postBody = "titleCode=${titleCode}&firstName=${firstName}&lastName=${lastName}&line1=Bayerstr.+10a&town=${town2}&countryIsoCode=DE&postcode=80335"
	...
	void testDeleteAddress() {
		...
		//delete address
		def con = TestUtil.getSecureConnection("/customers/current/addresses/" + aid, 'DELETE', 'XML', HttpURLConnection.HTTP_OK, null, null, access_token)
	...
	void testDeleteAddressJSON() {
		...
		//delete address
		def con = TestUtil.getSecureConnection("/customers/current/addresses/" + aid, 'DELETE', 'JSON', HttpURLConnection.HTTP_OK, null, null, access_token)
	...
	void testEditAddress() {
		...
		//edit address
		def postBody = "town=Montreal&postcode=80335"
	...
	void testUpdateCustomerProfileXML() {
		...
		def postBody = "titleCode=mr&firstName=Udo&lastName=Hubertus&language=zh&currency=EUR"
		def con = TestUtil.getSecureConnection("/customers/current/profile", 'POST', 'XML', HttpURLConnection.HTTP_OK, postBody, null, access_token)
		//println body
		def response =   TestUtil.verifiedXMLSlurper(con)
	...
	void testUpdatePaymentAddress() {
		...
		/* when */
		def postBody = "titleCode=mr&firstName=ChangedFirstName&lastName=ChangedLastName&line1=ChangedLine1&line2=ChangedLine2&postcode=44-100&town=ChangedTown&countryIsoCode=DE"
	...
	void testUpdatePaymentAddressJSON() {
		...
		/* when */
		def postBody = "titleCode=ms&firstName=ChangedFirstName&lastName=ChangedLastName&line1=ChangedLine1&line2=ChangedLine2&postcode=44-100&town=ChangedTown&countryIsoCode=DE"
	...
	void testPaymentInfosFlowJSON() {
		...
		postBody = "titleCode=mr&firstName=ChangedFirstName&lastName=ChangedLastName&line1=ChangedLine1&line2=ChangedLine2&postcode=44-100&town=ChangedTown&countryIsoCode=DE"
	...
	void testChangeLoginXML() {
		...
		def con = TestUtil.getSecureConnection("/customers/current/login", 'POST', 'XML', HttpURLConnection.HTTP_OK, postBody, null, access_token)
		def response =   TestUtil.verifiedXMLSlurper(con)
	...
	void testChangeLoginJSON() {
		...
		def postBody = "newLogin=${newUid}&password=${password}"
		def con = TestUtil.getSecureConnection("/customers/current/login", 'POST', 'JSON', HttpURLConnection.HTTP_OK, postBody, null, access_token)
		def response = TestUtil.verifiedJSONSlurper(con)
		assert response.success
	}
	...
	void testChangeLoginDuplicateUIDXML() {
		...
		def con = TestUtil.getSecureConnection("/customers/current/login", 'POST', 'XML', HttpURLConnection.HTTP_BAD_REQUEST, postBody, null, access_token)
		def response = new XmlSlurper().parseText(con.errorStream.text)
		assert response.'class' == 'DuplicateUidException'
	...
	void testChangeLoginDuplicateUIDJSON() {
		...
		// try to change uid from ${uid} to already existing ${existingUid}
		def postBody = "newLogin=${existingUid}&password=${password}"
		def con = TestUtil.getSecureConnection("/customers/current/login", 'POST', 'JSON', HttpURLConnection.HTTP_BAD_REQUEST, postBody, null, access_token)
		def response = new JsonSlurper().parseText(con.errorStream.text)
		assert response.'class' == 'DuplicateUidException'
		assert response.message.toString().contains(existingUid)
	}
