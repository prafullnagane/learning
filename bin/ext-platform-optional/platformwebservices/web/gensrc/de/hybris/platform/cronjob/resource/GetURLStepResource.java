...
/**
 * Generated resource class for type GetURLStep first defined at extension processing
 */
@SuppressWarnings("all")
public class GetURLStepResource extends AbstractYResource<GetURLStepModel>
{
	/**
	 * <i>Generated constructor</i> - for generic creation.
	 */
	public GetURLStepResource()
	{
		super("GetURLStep");
	}
	 ...
	 */
	@DELETE
	public Response deleteGetURLStep()
	{
	 ...
	 */
	public GetURLStepModel getGetURLStepModel()
	{
	 ...
	 */
	@PUT
	public Response putGetURLStep(final GetURLStepDTO dto)
	{
		return createPutResponse(dto).build();
	}
	
	/**
	 * Gets the {@link GetURLStepModel} resource which is addressed by current resource request.
	 * @see de.hybris.platform.webservices.AbstractYResource#readResource(String)
	 */
	@Override
	protected GetURLStepModel readResource(final String resourceId) throws Exception
	{
		GetURLStepModel model = new GetURLStepModel();
		model.setCode(resourceId);
		return (GetURLStepModel) readResourceInternal(model);
	}
	
	/**
	 * Convenience method which just delegates to {@link #setResourceValue(GetURLStepModel)}
	 */
	public void setGetURLStepModel(final GetURLStepModel value)
	{
