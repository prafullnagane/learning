...
public class CisAvsAddressPopulatorTest
{
	...
	public void shouldPopulate()
	{
		...
		//Assert.assertEquals("line1", target.getAddressLine1()); TODO dynamic attributes don't seem to work in a unit test
		//Assert.assertEquals("line2", target.getAddressLine2()); TODO dynamic attributes don't seem to work in a unit test
