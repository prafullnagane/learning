...
/**
 * Generated resource class for type CSVExportStep first defined at extension processing
 */
@SuppressWarnings("all")
public class CSVExportStepResource extends AbstractYResource<CSVExportStepModel>
{
	/**
	 * <i>Generated constructor</i> - for generic creation.
	 */
	public CSVExportStepResource()
	{
		super("CSVExportStep");
	}
	 ...
	 */
	@DELETE
	public Response deleteCSVExportStep()
	{
	 ...
	 */
	@GET
	public Response getCSVExportStep()
	{
	 ...
	 */
	public CSVExportStepModel getCSVExportStepModel()
	{
	 ...
	 */
	@PUT
	public Response putCSVExportStep(final CSVExportStepDTO dto)
	{
		return createPutResponse(dto).build();
	}
	
	/**
	 * Gets the {@link CSVExportStepModel} resource which is addressed by current resource request.
	 * @see de.hybris.platform.webservices.AbstractYResource#readResource(String)
	 */
	@Override
	protected CSVExportStepModel readResource(final String resourceId) throws Exception
	{
		CSVExportStepModel model = new CSVExportStepModel();
		model.setCode(resourceId);
		return (CSVExportStepModel) readResourceInternal(model);
	}
	
	/**
	 * Convenience method which just delegates to {@link #setResourceValue(CSVExportStepModel)}
	 */
	public void setCSVExportStepModel(final CSVExportStepModel value)
	{
