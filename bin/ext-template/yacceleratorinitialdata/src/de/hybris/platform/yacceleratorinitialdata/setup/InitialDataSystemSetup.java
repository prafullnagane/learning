...
public class InitialDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		...
		// importCommonData(context, "yacceleratorinitialdata");
		// This would import a standard store: (one basestore, one cmssite, one product catalog, one content catalog)
		// importStoreInitialData(context, "yacceleratorinitialdata", "yaccelerator", "yaccelerator", Collections.singletonList("yaccelerator"));
