...
public abstract class AbstractAfterSaveEventTest extends HybrisJUnit4Test
{
	...
	void assertEvent(final Item i, final int type, final int amount, final List<AfterSaveEvent> allEvents)
	{
		final PK pk = i.getPK();
	...
	List<AfterSaveEvent> getEventsForItem(final Item i, final List<AfterSaveEvent> allEvents)
	{
		final PK pk = i.getPK();
