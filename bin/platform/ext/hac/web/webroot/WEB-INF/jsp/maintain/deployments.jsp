...
<head>
	...
	<link rel="stylesheet" href="<c:url value="/static/css/maintain/deployments.css"/>" type="text/css" media="screen, projection" />	
	...
	<body>
							...
							<table id="typesWith">
								...
								<tbody>
							      <c:forEach var="item" items="${typesWith}">
							        <tr title="PK: ${item.typePK} | Properties Table: ${item.propsTable} | Persistent: ${item.persistent}| Abstract: ${item.abstract} | Final: ${item.final}">
							          <td>${item.typecode}</td>
							          <td>${item.table}</td>
							          <td>${item.type}</td>
			...
			<div class="span-6 last" id="sidebar1">
				<div class="prepend-top">
					...
					<div class="box">
						<div class="quiet">
						This page provides a list of all types which have a deployment, including types with a deployment inherited from their supertype. Move the pointer over a row to see more details about the type.
						</div>
					</div>
					<h3 class="caps">
					...
					<div class="box">
						<ul>
							<li> <a href="https://wiki.hybris.com/display/release4/Types+Deployment" target="_blank" class="quiet" >Specifying a Deployment for hybris Platform Types</a> </li>
						</ul>
					</div>
				</div>
			</div>
			...
			<div class="span-6 last" id="sidebar2">
				<div class="prepend-top">
					...
					<div class="box">
						<div class="quiet">
						This page provides a list of all types with no explicit or inherited deployment. Move the pointer over a row to see more details about the type.
						</div>
					</div>
					<h3 class="caps">
						See also in the hybris Wiki
