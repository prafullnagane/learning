	...
	<div class="prepend-top span-17 colborder" id="content">
		...
		<div class="marginLeft">
			...
			<p> 
				...
				The <a href="https://wiki.hybris.com/display/release4/dynaTrace+Installation" target="_blank" class="quiet">installation</a> takes only a few minutes and
	...
	<div class="span-6 last" id="sidebar">
		<div class="prepend-top" id="recent-reviews">
			...
			<div class="box">
				...
				<hr/>
				<div class=quiet>
					<a href="https://wiki.hybris.com/display/release4/dynaTrace" target="_blank" class="quiet" ><img style="margin:0" src="<c:url value="/static/img/dynatrace/video.png"/>"/>
			...
			<div class="box">
				<ul>
					<li> <a href="https://wiki.hybris.com/display/release4/dynaTrace" target="_blank" class="quiet" >dynaTrace Application Performance Management</a> </li>
					<li> <a href="https://wiki.hybris.com/display/release4/dynaTrace+Installation" target="_blank" class="quiet" >dynaTrace hybris Edition Installation Guide</a> </li>
				</ul>
			</div>
		</div>
	</div>
