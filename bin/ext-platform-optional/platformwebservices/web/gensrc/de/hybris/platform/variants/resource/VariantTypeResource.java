...
/**
 * Generated resource class for type VariantType first defined at extension catalog
 */
@SuppressWarnings("all")
public class VariantTypeResource extends AbstractYResource<VariantTypeModel>
{
	/**
	 * <i>Generated constructor</i> - for generic creation.
	 */
	public VariantTypeResource()
	{
		super("VariantType");
	}
	 ...
	 */
	@DELETE
	public Response deleteVariantType()
	{
	 ...
	 */
	@GET
	public Response getVariantType()
	{
	 ...
	 */
	public VariantTypeModel getVariantTypeModel()
	{
	 ...
	 */
	@PUT
	public Response putVariantType(final VariantTypeDTO dto)
	{
		return createPutResponse(dto).build();
	}
	
	/**
	 * Gets the {@link VariantTypeModel} resource which is addressed by current resource request.
	 * @see de.hybris.platform.webservices.AbstractYResource#readResource(String)
	 */
	@Override
	protected VariantTypeModel readResource(final String resourceId) throws Exception
	{
		VariantTypeModel model = new VariantTypeModel();
		model.setCode(resourceId);
		return (VariantTypeModel) readResourceInternal(model);
	}
	
	/**
	 * Convenience method which just delegates to {@link #setResourceValue(VariantTypeModel)}
	 */
	public void setVariantTypeModel(final VariantTypeModel value)
	{
