...
public class PromotionsPopulatorTest
{
	...
	private PromotionsPopulator promotionsPopulator = new PromotionsPopulator();
	...
	public void setUp()
	{
		...
		promotionsConverter = new ConverterFactory<AbstractPromotionModel, PromotionData, PromotionsPopulator>().create(PromotionData.class, promotionsPopulator);
	}
