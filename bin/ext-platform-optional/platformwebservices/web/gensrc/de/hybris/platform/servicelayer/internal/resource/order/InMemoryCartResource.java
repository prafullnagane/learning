...
/**
 * Generated resource class for type InMemoryCart first defined at extension core
 */
@SuppressWarnings("all")
public class InMemoryCartResource extends AbstractYResource<InMemoryCartModel>
{
	/**
	 * <i>Generated constructor</i> - for generic creation.
	 */
	public InMemoryCartResource()
	{
		super("InMemoryCart");
	}
	 ...
	 */
	@DELETE
	public Response deleteInMemoryCart()
	{
	 ...
	 */
	@GET
	public Response getInMemoryCart()
	{
	 ...
	 */
	public InMemoryCartModel getInMemoryCartModel()
	{
	 ...
	 */
	@PUT
	public Response putInMemoryCart(final InMemoryCartDTO dto)
	{
		return createPutResponse(dto).build();
	}
	
	/**
	 * Gets the {@link InMemoryCartModel} resource which is addressed by current resource request.
	 * @see de.hybris.platform.webservices.AbstractYResource#readResource(String)
	 */
	@Override
	protected InMemoryCartModel readResource(final String resourceId) throws Exception
	{
		InMemoryCartModel model = new InMemoryCartModel();
		model.setCode(resourceId);
		return (InMemoryCartModel) readResourceInternal(model);
	}
	
	/**
	 * Convenience method which just delegates to {@link #setResourceValue(InMemoryCartModel)}
	 */
	public void setInMemoryCartModel(final InMemoryCartModel value)
	{
