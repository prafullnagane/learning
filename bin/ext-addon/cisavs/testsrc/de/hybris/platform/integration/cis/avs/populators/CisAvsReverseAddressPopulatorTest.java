...
public class CisAvsReverseAddressPopulatorTest
{
	...
	{
		CisAddress source = new CisAddress();
		...
		//Assert.assertEquals("line1", target.getLine1()); TODO dynamic attributes don't seem to work in a unit test
		//Assert.assertEquals("line2", target.getLine2()); TODO dynamic attributes don't seem to work in a unit test
