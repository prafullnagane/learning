		...
		Populator<SOURCE, TARGET>
{
	...
	protected void addPaymentInformation(final AbstractOrderModel source, final AbstractOrderData prototype)
	{
		...
		{
			prototype.setPaymentInfo(getCreditCardPaymentInfoConverter().convert((CreditCardPaymentInfoModel) paymentInfo));
		}
	}
	...
	{
		//Set this flag for offline processing by order process.
