...
import de.hybris.platform.solrfacetsearch.integration.AbstractSolrEmbeddedTest;
...
public class SolrAutoSuggestServiceTest extends AbstractSolrEmbeddedTest
{
	...
	public void testSuggestions() throws SolrAutoSuggestException, IndexUpdateException
	{
		...
		suggestion = solrAutoSuggestService.getAutoSuggestionsForQuery(english, indexedTypeModel, "suggest1");
		assertThat(suggestion.getSuggestions().get("suggest1")).isNotEmpty();
