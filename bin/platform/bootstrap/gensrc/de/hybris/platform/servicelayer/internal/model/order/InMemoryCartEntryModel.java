...
public class InMemoryCartEntryModel extends CartEntryModel
{
	 ...
	 * @param _order initial attribute declared by type <code>InMemoryCartEntry</code> at extension <code>core</code>
	 ...
	 */
	@Deprecated
	public InMemoryCartEntryModel(final InMemoryCartModel _order, final ProductModel _product, final Long _quantity, final UnitModel _unit)
	{
		super();
		setOrder(_order);
		setProduct(_product);
	 ...
	 */
	@Deprecated
	public InMemoryCartEntryModel(final InMemoryCartModel _order, final ItemModel _owner, final ProductModel _product, final Long _quantity, final UnitModel _unit)
	{
		super();
		setOrder(_order);
		setOwner(_owner);
