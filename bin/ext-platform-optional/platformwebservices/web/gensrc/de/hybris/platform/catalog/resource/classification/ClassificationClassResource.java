...
/**
 * Generated resource class for type ClassificationClass first defined at extension catalog
 */
@SuppressWarnings("all")
public class ClassificationClassResource extends AbstractYResource<ClassificationClassModel>
{
	/**
	 * <i>Generated constructor</i> - for generic creation.
	 */
	public ClassificationClassResource()
	{
	 ...
	 */
	@DELETE
	public Response deleteClassificationClass()
	{
	 ...
	 */
	@GET
	public Response getClassificationClass()
	{
	 ...
	 */
	public ClassificationClassModel getClassificationClassModel()
	{
	 ...
	 */
	@PUT
	public Response putClassificationClass(final ClassificationClassDTO dto)
	{
		return createPutResponse(dto).build();
	}
	
	/**
	 * Gets the {@link ClassificationClassModel} resource which is addressed by current resource request.
	 * @see de.hybris.platform.webservices.AbstractYResource#readResource(String)
	 */
	@Override
	protected ClassificationClassModel readResource(final String resourceId) throws Exception
	{
		ClassificationClassModel model = new ClassificationClassModel();
		model.setCode(resourceId);
		return (ClassificationClassModel) readResourceInternal(model);
	}
	
	/**
	 * Convenience method which just delegates to {@link #setResourceValue(ClassificationClassModel)}
	 */
	public void setClassificationClassModel(final ClassificationClassModel value)
	{
