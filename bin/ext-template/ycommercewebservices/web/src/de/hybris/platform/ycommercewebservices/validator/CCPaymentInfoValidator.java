...
public class CCPaymentInfoValidator implements Validator
{
	...
	public void validate(final Object target, final Errors errors)
	{
		...
		ValidationUtils.rejectIfEmptyOrWhitespace(errors, "billingAddress.titleCode", "field.required");
		ValidationUtils.rejectIfEmptyOrWhitespace(errors, "billingAddress.firstName", "field.required");
		ValidationUtils.rejectIfEmptyOrWhitespace(errors, "billingAddress.lastName", "field.required");
		ValidationUtils.rejectIfEmptyOrWhitespace(errors, "billingAddress.line1", "field.required");
		ValidationUtils.rejectIfEmptyOrWhitespace(errors, "billingAddress.town", "field.required");
		ValidationUtils.rejectIfEmptyOrWhitespace(errors, "billingAddress.postalCode", "field.required");
		ValidationUtils.rejectIfEmptyOrWhitespace(errors, "billingAddress.country", "field.required");
	}
}
