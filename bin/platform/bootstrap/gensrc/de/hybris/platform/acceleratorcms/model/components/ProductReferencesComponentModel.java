...
public class ProductReferencesComponentModel extends SimpleCMSComponentModel
{
	 ...
	 */
	@Deprecated
	public ProductReferencesComponentModel(final CatalogVersionModel _catalogVersion, final Integer _maximumNumberProducts, final String _uid)
	{
		super();
	 ...
	 */
	@Deprecated
	public ProductReferencesComponentModel(final CatalogVersionModel _catalogVersion, final Integer _maximumNumberProducts, final ItemModel _owner, final String _uid)
	{
		super();
		setCatalogVersion(_catalogVersion);
		setMaximumNumberProducts(_maximumNumberProducts);
