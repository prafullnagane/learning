...
public class MasterTenantUnitTest
{
	...
	public void testShutdownDuringReconnectMasterCallsShutdownDuringReconnectForSlaves()
	{
		...
		master.doShutDownIfConnectionIsBroken();

		Mockito.verify(foo).shutDown(ShutDownMode.CONNECTION_BROKEN);
		Mockito.verify(bar).shutDown(ShutDownMode.CONNECTION_BROKEN);
