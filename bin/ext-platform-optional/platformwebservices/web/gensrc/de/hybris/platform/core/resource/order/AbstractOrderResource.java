...
/**
 * Generated resource class for type AbstractOrder first defined at extension core
 */
@SuppressWarnings("all")
public class AbstractOrderResource extends AbstractYResource<AbstractOrderModel>
{
	/**
	 ...
	 */
	@DELETE
	public Response deleteAbstractOrder()
	{
	 ...
	 */
	@GET
	public Response getAbstractOrder()
	{
	 ...
	 */
	@PUT
	public Response putAbstractOrder(final AbstractOrderDTO dto)
	{
		return createPutResponse(dto).build();
	}
	
	/**
	 * Gets the {@link AbstractOrderModel} resource which is addressed by current resource request.
	 * @see de.hybris.platform.webservices.AbstractYResource#readResource(String)
	 */
	@Override
	protected AbstractOrderModel readResource(final String resourceId) throws Exception
	{
		AbstractOrderModel model = new AbstractOrderModel();
		model.setCode(resourceId);
		return (AbstractOrderModel) readResourceInternal(model);
	}
	
	/**
	 * Convenience method which just delegates to {@link #setResourceValue(AbstractOrderModel)}
	 */
	public void setAbstractOrderModel(final AbstractOrderModel value)
	{
