...
/**
 * Generated resource class for type FlexibleSearchCronJob first defined at extension processing
 */
@SuppressWarnings("all")
public class FlexibleSearchCronJobResource extends AbstractYResource<FlexibleSearchCronJobModel>
{
	/**
	 * <i>Generated constructor</i> - for generic creation.
	 */
	public FlexibleSearchCronJobResource()
	{
	 ...
	 */
	@DELETE
	public Response deleteFlexibleSearchCronJob()
	{
	 ...
	 */
	@GET
	public Response getFlexibleSearchCronJob()
	{
	 ...
	 */
	public FlexibleSearchCronJobModel getFlexibleSearchCronJobModel()
	{
	 ...
	 */
	@PUT
	public Response putFlexibleSearchCronJob(final FlexibleSearchCronJobDTO dto)
	{
		return createPutResponse(dto).build();
	}
	
	/**
	 * Gets the {@link FlexibleSearchCronJobModel} resource which is addressed by current resource request.
	 * @see de.hybris.platform.webservices.AbstractYResource#readResource(String)
	 */
	@Override
	protected FlexibleSearchCronJobModel readResource(final String resourceId) throws Exception
	{
		FlexibleSearchCronJobModel model = new FlexibleSearchCronJobModel();
		model.setCode(resourceId);
		return (FlexibleSearchCronJobModel) readResourceInternal(model);
	}
	
	/**
	 * Convenience method which just delegates to {@link #setResourceValue(FlexibleSearchCronJobModel)}
	 */
	public void setFlexibleSearchCronJobModel(final FlexibleSearchCronJobModel value)
	{
