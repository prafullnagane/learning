...
/**
 * Generated resource class for type CMSComponentType first defined at extension cms2
 */
@SuppressWarnings("all")
public class CMSComponentTypeResource extends AbstractYResource<CMSComponentTypeModel>
{
	/**
	 * <i>Generated constructor</i> - for generic creation.
	 */
	public CMSComponentTypeResource()
	{
	 ...
	 */
	@DELETE
	public Response deleteCMSComponentType()
	{
	 ...
	 */
	@GET
	public Response getCMSComponentType()
	{
	 ...
	 */
	public CMSComponentTypeModel getCMSComponentTypeModel()
	{
	 ...
	 */
	@PUT
	public Response putCMSComponentType(final CMSComponentTypeDTO dto)
	{
		return createPutResponse(dto).build();
	}
	
	/**
	 * Gets the {@link CMSComponentTypeModel} resource which is addressed by current resource request.
	 * @see de.hybris.platform.webservices.AbstractYResource#readResource(String)
	 */
	@Override
	protected CMSComponentTypeModel readResource(final String resourceId) throws Exception
	{
		CMSComponentTypeModel model = new CMSComponentTypeModel();
		model.setCode(resourceId);
		return (CMSComponentTypeModel) readResourceInternal(model);
	}
	
	/**
	 * Convenience method which just delegates to {@link #setResourceValue(CMSComponentTypeModel)}
	 */
	public void setCMSComponentTypeModel(final CMSComponentTypeModel value)
	{
