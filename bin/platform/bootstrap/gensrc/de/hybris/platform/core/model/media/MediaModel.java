...
public class MediaModel extends AbstractMediaModel
{
	 ...
	 */
	@Deprecated
	public MediaModel(final CatalogVersionModel _catalogVersion, final String _code, final MediaFolderModel _folder, final ItemModel _owner)
	{
		super();
		setCatalogVersion(_catalogVersion);
		setCode(_code);
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>Media.URL</code> attribute defined at extension <code>core</code>. 
	 * @return the URL
	 */
	...
	/**
	 * <i>Generated method</i> - Initial setter of <code>Media.folder</code> attribute defined at extension <code>core</code>. Can only be used at creation of model - before first save.  
	 *  
	...
	/**
	 * <i>Generated method</i> - Setter of <code>Media.URL</code> attribute defined at extension <code>core</code>. 
	 *  
	 * @param value the URL
	 */
