...
public class DefaultBusinessProcessServiceTest
{
	...
	public void setUp() throws Exception
	{
		...
		mockProcessDefinition = EasyMock.createNiceMock(ProcessDefinition.class);
	...
	public void testStartProcess()
	{
		...
		expect(processDefinitionFactory.getProcessDefinition(processDefinitionName)).andReturn(mockProcessDefinition);
