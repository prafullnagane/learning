...
public class DefaultStoreSessionFacadeTest
{
	...
	public void setUp()
	{
		...
		defaultStoreSessionFacade.setLanguageResolver(languageResolver);
	...
	public void testInitializeSession() throws CalculationException
	{
		...
		given(languageResolver.getLanguage(preferredLocale.getCountry())).willReturn(languageModel);
		...
		Mockito.verify(cartModel).setCurrency(currencyModel);
		Mockito.verify(commerceCartService).recalculateCart(cartModel);
	}
