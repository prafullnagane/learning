...
import de.hybris.platform.cms2.dto.relations.CMSRelationsDTO;
...
/**
 * Generated REST root resource for a collection of elements of  type CMSRelation defined at extension cms2 Allowed methods: GET, POST, PUT, DELETE, HEADER  
 */
@SuppressWarnings("all")
@Path("/cmsrelations")
public class CMSRelationsResource extends AbstractCollectionResource <Collection<CMSRelationModel>>
{
	/**
	...
	{
		return createGetResponse().build(CMSRelationsDTO.class);
	}
	 ...
	 */
	public Collection<CMSRelationModel> getCMSRelationsCollection()
	{
	 ...
	 */
	public void setCMSRelationsCollection(final Collection<CMSRelationModel> value)
	{
