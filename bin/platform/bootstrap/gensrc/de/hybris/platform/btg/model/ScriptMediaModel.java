...
public class ScriptMediaModel extends MediaModel
{
	 ...
	 */
	@Deprecated
	public ScriptMediaModel(final CatalogVersionModel _catalogVersion, final String _code, final MediaFolderModel _folder, final ItemModel _owner, final String _scriptLanguage)
	{
		super();
		setCatalogVersion(_catalogVersion);
		setCode(_code);
