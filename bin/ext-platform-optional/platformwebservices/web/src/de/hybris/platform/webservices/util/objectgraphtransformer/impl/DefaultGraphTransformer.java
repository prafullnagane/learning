...
public class DefaultGraphTransformer extends AbstractGraphTransformer
{
	...
	private static final Logger log = Logger.getLogger(DefaultGraphTransformer.class);
	...
	public void initialize()
	{
		...
		{
			@Override
			public int compare(final NodeMapping o1, final NodeMapping o2)
			{
				return o1.getSourceConfig().getType().getName().compareTo(o2.getSourceConfig().getType().getName());
			}
		});
