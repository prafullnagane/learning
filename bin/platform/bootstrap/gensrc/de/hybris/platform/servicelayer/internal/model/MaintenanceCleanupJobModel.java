...
public class MaintenanceCleanupJobModel extends ServicelayerJobModel
{
	 ...
	 * @return the threshold - Depending on the implemented Maintenance strategy this threeshold value can be uses as 'days old' or as max/min value ...
	 */
	 ...
	 *  
	 * @param value the threshold - Depending on the implemented Maintenance strategy this threeshold value can be uses as 'days old' or as max/min value ...
	 */
