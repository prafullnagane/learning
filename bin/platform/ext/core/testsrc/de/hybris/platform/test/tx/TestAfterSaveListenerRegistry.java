...
final class TestAfterSaveListenerRegistry extends DefaultAfterSaveListenerRegistry
{
	...
	static TestAfterSaveListenerRegistry createAsyncDeliveryRegistry()
	{
		...
		{
			@Override
			public void afterSave(final Collection<AfterSaveEvent> e)
			{
				fakeRegistry.getEvents().addAll(e);
			}
		});
	...
	@Override
	protected void notifyListenersSynchronously(final Collection<AfterSaveEvent> e)
	{
		if (async)
		{
