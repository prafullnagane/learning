...
import de.hybris.platform.btg.dto.BTGItemsDTO;
...
/**
 * Generated REST root resource for a collection of elements of  type BTGItem defined at extension btg Allowed methods: GET, POST, PUT, DELETE, HEADER  
 */
@SuppressWarnings("all")
@Path("/btgitems")
public class BTGItemsResource extends AbstractCollectionResource <Collection<BTGItemModel>>
{
	/**
	...
	{
		return createGetResponse().build(BTGItemsDTO.class);
	}
	 ...
	 */
	public Collection<BTGItemModel> getBTGItemsCollection()
	{
	 ...
	 */
	public void setBTGItemsCollection(final Collection<BTGItemModel> value)
	{
