		...
		Populator<HttpServletRequest, AddressData>
{
	...
	private static final String COUNTRY = "countryIsoCode";
	private static final String REGION = "regionIsoCode";
	...
	@Override
	public void populate(final HttpServletRequest request, final AddressData addressData) throws ConversionException
	{
	...
	protected CountryData updateCountryFromRequest(final HttpServletRequest request, final CountryData defaultValue)
	{
		...
		{
			return getCheckoutFacade().getCountryForIsocode(countryIsoCode);
		}
		return defaultValue;
	}
	...
	protected RegionData updateRegionFromRequest(final HttpServletRequest request, final RegionData defaultValue)
	{
		...
		{
			return i18nFacade.getRegion(countryIsoCode, regionIsoCode);
		}
		return defaultValue;
	}
