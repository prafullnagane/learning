...
/**
 * Generated resource class for type SolrQueryStatisticsCollectorCronJob first defined at extension solrfacetsearch
 */
@SuppressWarnings("all")
public class SolrQueryStatisticsCollectorCronJobResource extends AbstractYResource<SolrQueryStatisticsCollectorCronJobModel>
{
	/**
	 * <i>Generated constructor</i> - for generic creation.
	 */
	public SolrQueryStatisticsCollectorCronJobResource()
	{
	 ...
	 */
	@DELETE
	public Response deleteSolrQueryStatisticsCollectorCronJob()
	{
	 ...
	 */
	@GET
	public Response getSolrQueryStatisticsCollectorCronJob()
	{
	 ...
	 */
	public SolrQueryStatisticsCollectorCronJobModel getSolrQueryStatisticsCollectorCronJobModel()
	{
	 ...
	 */
	@PUT
	public Response putSolrQueryStatisticsCollectorCronJob(final SolrQueryStatisticsCollectorCronJobDTO dto)
	{
		return createPutResponse(dto).build();
	}
	
	/**
	 * Gets the {@link SolrQueryStatisticsCollectorCronJobModel} resource which is addressed by current resource request.
	 * @see de.hybris.platform.webservices.AbstractYResource#readResource(String)
	 */
	@Override
	protected SolrQueryStatisticsCollectorCronJobModel readResource(final String resourceId) throws Exception
	{
		SolrQueryStatisticsCollectorCronJobModel model = new SolrQueryStatisticsCollectorCronJobModel();
		model.setCode(resourceId);
		return (SolrQueryStatisticsCollectorCronJobModel) readResourceInternal(model);
	}
	
	/**
	 * Convenience method which just delegates to {@link #setResourceValue(SolrQueryStatisticsCollectorCronJobModel)}
	 */
	public void setSolrQueryStatisticsCollectorCronJobModel(final SolrQueryStatisticsCollectorCronJobModel value)
	{
