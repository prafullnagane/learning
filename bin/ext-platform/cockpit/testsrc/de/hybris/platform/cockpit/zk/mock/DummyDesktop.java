...
public class DummyDesktop implements Desktop, DesktopCtrl
{
	...
	@Override
	public void addEventInterceptor(final EventInterceptor ei)
	{
		//
	}
	...
	@Override
	public boolean removeEventInterceptor(final EventInterceptor ei)
	{
		return false;
	}
	...
	@Override
	public void recoverDidFail(final Throwable ex)
	{//
	}
	...
	@Override
	public void setVisualizer(final Visualizer uv)
	{//
	}
