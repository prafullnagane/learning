...
public class SimpleTypeColumnAlternationTest extends AbstractColumnAlternationTest
{
	...
	{
		checkTypeChange(new ColumnDefinitionImpl("VARCHAR", 100),
		//"varchar"varchar(100)",
				new ColumnDefinitionImpl("VARCHAR", 200),
				//		"varchar(200)", 
				getData(null));
	}
	...
	public void alterNChar2Varchar() throws SQLException, UpdateModelException
	{
		...
		{
			checkTypeChange(new ColumnDefinitionImpl("NCHAR", 100),
			//"varchar"varchar(100)",
					new ColumnDefinitionImpl("VARCHAR", 200),
					//		"varchar(200)", 
					getData(null));
	...
	public void alterNChar2NVarchar() throws SQLException, UpdateModelException
	{
		if (Config.isSQLServerUsed())
		{
			checkTypeChange(new ColumnDefinitionImpl("NCHAR", 100),
			//"varchar"varchar(100)",
					new ColumnDefinitionImpl("NVARCHAR", 200),
					//		"varchar(200)", 
					getData(null));
		}
	}
	...
	public void alterNChar2Binary() throws SQLException, UpdateModelException
	{
		if (Config.isSQLServerUsed())
		{
			try
			{
				checkTypeChange(new ColumnDefinitionImpl("NCHAR", 100),
				//"varchar"varchar(100)",
						new ColumnDefinitionImpl("BINARY", 200),
						//		"varchar(200)", 
						getData(null));
			}
	...
	public void alterNChar2VarBinary() throws SQLException, UpdateModelException
	{
		if (Config.isSQLServerUsed())
		{
			try
			{
				checkTypeChange(new ColumnDefinitionImpl("NCHAR", 100),
				//"varchar"varchar(100)",
						new ColumnDefinitionImpl("VARBINARY", 200),
						//		"varchar(200)", 
						getData(null));
			}
			catch (final UpdateModelException e)
	...
	public void alterNVarchar2Char() throws SQLException, UpdateModelException
	{
		if (Config.isSQLServerUsed())
		{
			checkTypeChange(new ColumnDefinitionImpl("NVARCHAR", 100),
			//"varchar"varchar(100)",
					new ColumnDefinitionImpl("CHAR", 200),
					//		"varchar(200)", 
					getData(null));
		}
	}
	...
	public void alterNVarchar2NChar() throws SQLException, UpdateModelException
	{
		if (Config.isSQLServerUsed())
		{
			checkTypeChange(new ColumnDefinitionImpl("NVARCHAR", 100),
			//"varchar"varchar(100)",
					new ColumnDefinitionImpl("NCHAR", 200),
					//		"varchar(200)", 
					getData(null));
		}
	}
	...
	{
		checkTypeChange(new ColumnDefinitionImpl("CHAR", 100),
		//"varchar"varchar(100)",
				new ColumnDefinitionImpl("VARCHAR", 200),
				//		"varchar(200)", 
				getData(null));
	...
	public void alterChar2Binary() throws SQLException, UpdateModelException
	{
		try
		{
			if (Config.isHSQLDBUsed())
			{
				checkTypeChange(new ColumnDefinitionImpl("CHAR", 100),
				//"varchar"varchar(100)",
						new ColumnDefinitionImpl("BINARY", 200), new ColumnDefinitionImpl("CHAR", 100),
						//		"varchar(200)", 
						getData(null));
			}
			else
	...
	public void alterChar2VarBinary() throws SQLException, UpdateModelException
	{
		try
		{
			if (Config.isHSQLDBUsed())
			{
				checkTypeChange(new ColumnDefinitionImpl("CHAR", 100),
				//"varchar"varchar(100)",
						new ColumnDefinitionImpl("VARBINARY", 200), new ColumnDefinitionImpl("CHAR", 100),
						//		"varchar(200)", 
						getData(null));
			}
			else
	...
	{
		checkTypeChange(new ColumnDefinitionImpl("VARCHAR", 200),
		//"varchar"varchar(100)",
				new ColumnDefinitionImpl("CHAR", 200),
				//		"varchar(200)", 
				getData(null));
	...
	public void alterVarchar2Binary() throws SQLException, UpdateModelException
	{
		try
		{
			if (Config.isHSQLDBUsed())
			{
				checkTypeChange(new ColumnDefinitionImpl("VARCHAR", 100),
				//"varchar"varchar(100)",
						new ColumnDefinitionImpl("BINARY", 200), new ColumnDefinitionImpl("VARCHAR", 100),
						//		"varchar(200)", 
						getData(null));
			}
			else
	...
	public void alterVarchar2VarBinary() throws SQLException, UpdateModelException
	{
		try
		{
			if (Config.isHSQLDBUsed())
			{
				checkTypeChange(new ColumnDefinitionImpl("VARCHAR", 100),
				//"varchar"varchar(100)",
						new ColumnDefinitionImpl("VARBINARY", 200), new ColumnDefinitionImpl("VARCHAR", 100),
						//		"varchar(200)", 
						getData(null));
			}
			else
	...
	public void alterBinary2Char() throws SQLException, UpdateModelException
	{
		try
		{
			if (Config.isHSQLDBUsed())
			{
				checkTypeChange(new ColumnDefinitionImpl("BINARY", 200),
				//"varchar"varchar(100)",
						new ColumnDefinitionImpl("CHAR", 200), new ColumnDefinitionImpl("BINARY", 200),
						//		"varchar(200)", 
						getData(null));
			}
			else
	...
	public void alterBinary2Varchar() throws SQLException, UpdateModelException
	{
		...
		if (!Config.isSQLServerUsed())
		{
			try
			{
				if (Config.isHSQLDBUsed())
				{
					checkTypeChange(new ColumnDefinitionImpl("BINARY", 100),
					//"varchar"varchar(100)",
							new ColumnDefinitionImpl("VARCHAR", 200), new ColumnDefinitionImpl("BINARY", 100),
							//		"varchar(200)", 
							getData(null));
				}
				else
		...
		if (!Config.isSQLServerUsed())
		{
			try
			{
				if (Config.isHSQLDBUsed())
				{
					checkTypeChange(new ColumnDefinitionImpl("BINARY", 100),
					//"varchar"varchar(100)",
							new ColumnDefinitionImpl("VARBINARY", 200), new ColumnDefinitionImpl("BINARY", 100),
							//		"varchar(200)", 
							getData(null));
				}
				else
	...
	public void alterVarBinary2Char() throws SQLException, UpdateModelException
	{
		...
		if (!Config.isSQLServerUsed())
		{
			try
			{
				if (Config.isHSQLDBUsed())
				{
					checkTypeChange(new ColumnDefinitionImpl("VARBINARY", 200),
					//"varchar"varchar(100)",
							new ColumnDefinitionImpl("CHAR", 200), new ColumnDefinitionImpl("VARBINARY", 200),
							//		"varchar(200)", 
							getData(null));
				}
				else
	...
	public void alterVarBinary2Varchar() throws SQLException, UpdateModelException
	{
		...
		if (!Config.isSQLServerUsed())
		{
			try
			{
				if (Config.isHSQLDBUsed())
				{
					checkTypeChange(new ColumnDefinitionImpl("VARBINARY", 100),
					//"varchar"varchar(100)",
							new ColumnDefinitionImpl("VARCHAR", 200), new ColumnDefinitionImpl("VARBINARY", 100),
							//		"varchar(200)", 
							getData(null));
				}
				else
	...
	public void alterVarBinary2TinyBlob() throws SQLException, UpdateModelException
	{
		if (Config.isMySQLUsed())
		{
			if (Config.isHSQLDBUsed())
			{
				checkTypeChange(new ColumnDefinitionImpl("VARBINARY", 100),
				//"varchar"varchar(100)",
						new ColumnDefinitionImpl("TINYBLOB"), new ColumnDefinitionImpl("VARBINARY", 100),
						//		"varchar(200)", 
						getData(null));
			}
			else
	...
	public void alterInt() throws SQLException, UpdateModelException
	{
		...
		{
			checkTypeChange(new ColumnDefinitionImpl("TINYINT"), (!Config.isHSQLDBUsed() ? new ColumnDefinitionImpl("INT", 10)
					: new ColumnDefinitionImpl("INT")), Integer.valueOf(-127), Integer.valueOf(-23), Integer.valueOf(0),
					Integer.valueOf(1), Integer.valueOf(2), Integer.valueOf(3), Integer.valueOf(4), Integer.valueOf(45),
					Integer.valueOf(5), Integer.valueOf(126), Integer.valueOf(127));
		}
	}
	...
	public void alterFloat() throws SQLException, UpdateModelException
	{
		...
		{
			checkTypeChange(new ColumnDefinitionImpl("FLOAT"), (!Config.isHSQLDBUsed() ? new ColumnDefinitionImpl("DOUBLE", 22, 0)
					: new ColumnDefinitionImpl("DOUBLE")), Float.valueOf(-1.34535f), Float.valueOf(2.3453f), Float.valueOf(32435f),
					Float.valueOf(0.000043f), Float.valueOf(4537846734.323f), Float.valueOf(5f), Float.valueOf(645623924763f));
		}
	}
