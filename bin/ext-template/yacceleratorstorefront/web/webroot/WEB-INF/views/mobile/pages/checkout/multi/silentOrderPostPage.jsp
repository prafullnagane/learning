					...
					<div class="payment_details_right_col saved-payment-list">
						...
						<c:forEach items="${paymentInfos}" var="paymentInfo">
							<div class="saved-payment-list-entry">
								<form action="/yacceleratorstorefront/checkout/multi/select-payment-method" method="GET">
								...
								<form action="/yacceleratorstorefront/checkout/multi/remove-payment-method" method="POST" class="remove-payment-item-form">
