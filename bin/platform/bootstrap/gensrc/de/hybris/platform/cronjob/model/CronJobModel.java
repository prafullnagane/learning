...
public class CronJobModel extends ItemModel
{
	 ...
	 * @return the active - Whether the CronJob is active (is run when its trigger is due). If set to false, the CronJob will not be executed if its trigger is due
	 */
	 ...
	 * @return the logToDatabase - Whether the CronJob's execution log is written to a log entry in the hybris Suite's database
	 */
	 ...
	 * @return the nodeID - The number of the cluster node on which the CronJob is to be run. This setting is relevant for clustered hybris Suite installations only.
	 */
	 ...
	 * @return the retry - If an assigned job can't be started because of an already running job, a trigger will be created for the the cronjob instance with current time as activation time. This one will be triggerd on next poll repeatedly till the cronjob gets executed once
	 */
	 ...
	 * @return the sessionUser - The user in whose context (access rights, restrictions, etc) the CronJob will be executed
	 */
	 ...
	 * @return the singleExecutable - If the assigned TriggerableJob instance can not be performed yet, a new Trigger for this CronJob will be created
	 */
	 ...
	 *  
	 * @param value the active - Whether the CronJob is active (is run when its trigger is due). If set to false, the CronJob will not be executed if its trigger is due
	 */
	 ...
	 *  
	 * @param value the logToDatabase - Whether the CronJob's execution log is written to a log entry in the hybris Suite's database
	 */
	 ...
	 *  
	 * @param value the nodeID - The number of the cluster node on which the CronJob is to be run. This setting is relevant for clustered hybris Suite installations only.
	 */
	 ...
	 *  
	 * @param value the retry - If an assigned job can't be started because of an already running job, a trigger will be created for the the cronjob instance with current time as activation time. This one will be triggerd on next poll repeatedly till the cronjob gets executed once
	 */
	 ...
	 *  
	 * @param value the sessionUser - The user in whose context (access rights, restrictions, etc) the CronJob will be executed
	 */
	 ...
	 *  
	 * @param value the singleExecutable - If the assigned TriggerableJob instance can not be performed yet, a new Trigger for this CronJob will be created
	 */
