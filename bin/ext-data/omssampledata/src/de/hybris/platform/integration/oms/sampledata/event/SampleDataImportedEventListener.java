...
public class SampleDataImportedEventListener extends AbstractEventListener<SampleDataImportedEvent>
{
	...
	private OmsSampleDataSystemSetup omsSampleDataSystemSetup;
	...
	protected void onEvent(final SampleDataImportedEvent event)
	{
		...
		getOmsSampleDataSystemSetup().importSampleData(event.getContext(), event.getImportData());
	}

	protected OmsSampleDataSystemSetup getOmsSampleDataSystemSetup()
	{
		return omsSampleDataSystemSetup;
	}

	@Required
	public void setOmsSampleDataSystemSetup(final OmsSampleDataSystemSetup omsSampleDataSystemSetup)
	{
		this.omsSampleDataSystemSetup = omsSampleDataSystemSetup;
	}
}
