 ...
 *  
 */
package de.hybris.platform.acceleratorservices.setup;
...
public abstract class AbstractSystemSetup
{
	...
	protected void importImpexFile(final SystemSetupContext context, final String file)
	{
	 ...
	 *           the message to log
	 */
	protected void logInfo(final SystemSetupContext context, final String message)
	{
		LOG.info(message);
	 ...
	 */
	protected void logError(final SystemSetupContext context, final String message, final Throwable throwable)
	{
	...
	protected void createProductCatalogSyncJob(final SystemSetupContext context, final String catalogId)
	{
		getSetupSyncJobService().createProductCatalogSyncJob(catalogId);
	}


	protected void createContentCatalogSyncJob(final SystemSetupContext context, final String catalogId)
	{
	 ...
	 */
	protected List<SyncItemJobModel> getCatalogSyncJob(final String catalogId) throws UnknownIdentifierException
	{
		return catalogVersionService.getCatalogVersion(catalogId, CatalogManager.OFFLINE_VERSION).getSynchronizations();
	}

	protected PerformResult executeCatalogSyncJob(final SystemSetupContext context, final String catalogId)
	{
	...
	protected boolean isSyncRerunNeeded(final PerformResult syncCronJobResult)
	{
