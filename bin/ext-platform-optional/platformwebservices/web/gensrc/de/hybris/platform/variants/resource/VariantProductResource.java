...
/**
 * Generated resource class for type VariantProduct first defined at extension catalog
 */
...
public class VariantProductResource extends AbstractYResource<VariantProductModel>
{
	 ...
	 */
	@GET
	public Response getVariantProduct()
	{
	 ...
	 */
	public VariantProductModel getVariantProductModel()
	{
	 ...
	 */
	@PUT
	public Response putVariantProduct(final VariantProductDTO dto)
	{
		return createPutResponse(dto).build();
	}
	
	/**
	 * Gets the {@link VariantProductModel} resource which is addressed by current resource request.
	 * @see de.hybris.platform.webservices.AbstractYResource#readResource(String)
	 */
	@Override
	protected VariantProductModel readResource(final String resourceId) throws Exception
	{
		VariantProductModel model = new VariantProductModel();
		model.setCode(resourceId);
		return (VariantProductModel) readResourceInternal(model);
	}
	
	/**
	 * Convenience method which just delegates to {@link #setResourceValue(VariantProductModel)}
	 */
	public void setVariantProductModel(final VariantProductModel value)
	{
