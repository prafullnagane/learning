...
/**
 * Generated resource class for type ApparelStyleVariantProduct first defined at extension merchandisecore
 */
@SuppressWarnings("all")
public class ApparelStyleVariantProductResource extends AbstractYResource<ApparelStyleVariantProductModel>
{
	/**
	 * <i>Generated constructor</i> - for generic creation.
	 */
	public ApparelStyleVariantProductResource()
	{
	 ...
	 */
	@DELETE
	public Response deleteApparelStyleVariantProduct()
	{
	 ...
	 */
	@GET
	public Response getApparelStyleVariantProduct()
	{
	 ...
	 */
	public ApparelStyleVariantProductModel getApparelStyleVariantProductModel()
	{
	 ...
	 */
	@PUT
	public Response putApparelStyleVariantProduct(final ApparelStyleVariantProductDTO dto)
	{
		return createPutResponse(dto).build();
	}
	
	/**
	 * Gets the {@link ApparelStyleVariantProductModel} resource which is addressed by current resource request.
	 * @see de.hybris.platform.webservices.AbstractYResource#readResource(String)
	 */
	@Override
	protected ApparelStyleVariantProductModel readResource(final String resourceId) throws Exception
	{
		ApparelStyleVariantProductModel model = new ApparelStyleVariantProductModel();
		model.setCode(resourceId);
		return (ApparelStyleVariantProductModel) readResourceInternal(model);
	}
	
	/**
	 * Convenience method which just delegates to {@link #setResourceValue(ApparelStyleVariantProductModel)}
	 */
	public void setApparelStyleVariantProductModel(final ApparelStyleVariantProductModel value)
	{
