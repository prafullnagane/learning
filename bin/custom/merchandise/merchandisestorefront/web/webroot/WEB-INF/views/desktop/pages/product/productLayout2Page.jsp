...
<template:page pageTitle="${pageTitle}">
	...
	<jsp:body>
		...
		<div id="breadcrumb" class="breadcrumb bbbbbbbbbbbbbbb">
		...
		<div class="span-18">
			<div class="span-18 productDetails" id="productDetailUpdateable">
		...
		<cms:pageSlot position="CrossSelling" var="comp" element="div" class="span-6 last productDetailsRightSide">
			<cms:component component="${comp}"/>
		</cms:pageSlot>
