...
/**
 * Generated resource class for type URLCronJob first defined at extension processing
 */
@SuppressWarnings("all")
public class URLCronJobResource extends AbstractYResource<URLCronJobModel>
{
	/**
	 * <i>Generated constructor</i> - for generic creation.
	 */
	public URLCronJobResource()
	{
		super("URLCronJob");
	}
	 ...
	 */
	@DELETE
	public Response deleteURLCronJob()
	{
	 ...
	 */
	public URLCronJobModel getURLCronJobModel()
	{
	 ...
	 */
	@PUT
	public Response putURLCronJob(final URLCronJobDTO dto)
	{
		return createPutResponse(dto).build();
	}
	
	/**
	 * Gets the {@link URLCronJobModel} resource which is addressed by current resource request.
	 * @see de.hybris.platform.webservices.AbstractYResource#readResource(String)
	 */
	@Override
	protected URLCronJobModel readResource(final String resourceId) throws Exception
	{
		URLCronJobModel model = new URLCronJobModel();
		model.setCode(resourceId);
		return (URLCronJobModel) readResourceInternal(model);
	}
	
	/**
	 * Convenience method which just delegates to {@link #setResourceValue(URLCronJobModel)}
	 */
	public void setURLCronJobModel(final URLCronJobModel value)
	{
