...
/**
 * Generated resource class for type SolrIndexerHotUpdateCronJob first defined at extension solrfacetsearch
 */
@SuppressWarnings("all")
public class SolrIndexerHotUpdateCronJobResource extends AbstractYResource<SolrIndexerHotUpdateCronJobModel>
{
	/**
	 * <i>Generated constructor</i> - for generic creation.
	 */
	public SolrIndexerHotUpdateCronJobResource()
	{
	 ...
	 */
	@DELETE
	public Response deleteSolrIndexerHotUpdateCronJob()
	{
	 ...
	 */
	@GET
	public Response getSolrIndexerHotUpdateCronJob()
	{
	 ...
	 */
	public SolrIndexerHotUpdateCronJobModel getSolrIndexerHotUpdateCronJobModel()
	{
	 ...
	 */
	@PUT
	public Response putSolrIndexerHotUpdateCronJob(final SolrIndexerHotUpdateCronJobDTO dto)
	{
		return createPutResponse(dto).build();
	}
	
	/**
	 * Gets the {@link SolrIndexerHotUpdateCronJobModel} resource which is addressed by current resource request.
	 * @see de.hybris.platform.webservices.AbstractYResource#readResource(String)
	 */
	@Override
	protected SolrIndexerHotUpdateCronJobModel readResource(final String resourceId) throws Exception
	{
		SolrIndexerHotUpdateCronJobModel model = new SolrIndexerHotUpdateCronJobModel();
		model.setCode(resourceId);
		return (SolrIndexerHotUpdateCronJobModel) readResourceInternal(model);
	}
	
	/**
	 * Convenience method which just delegates to {@link #setResourceValue(SolrIndexerHotUpdateCronJobModel)}
	 */
	public void setSolrIndexerHotUpdateCronJobModel(final SolrIndexerHotUpdateCronJobModel value)
	{
