...
public class TaxValuesCountTest extends ServicelayerTest
{
	...
	public void setUp()
	{
		...
		testCatalog = new CatalogModel();
		testCatalog.setId("testCatalog");
		modelService.save(testCatalog);
		testCatalogVersionOnline = new CatalogVersionModel();
		...
		testCatalogVersionStaged = new CatalogVersionModel();
	...
	public void taxRowsMatchWhenCacheEnabledTest() throws Exception
	{
		...
		final AbstractOrderEntry entry = (AbstractOrderEntry) modelService.getSource(orderEntry1);
