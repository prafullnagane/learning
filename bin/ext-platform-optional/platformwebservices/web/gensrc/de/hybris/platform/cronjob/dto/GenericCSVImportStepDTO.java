...
@GraphNode(target = GenericCSVImportStepModel.class, factory = GenericNodeFactory.class, uidProperties="code")
@XmlRootElement(name = "genericcsvimportstep")
public class GenericCSVImportStepDTO extends MediaProcessorStepDTO
{
	/**
	 * <i>Generated constructor</i> - for generic creation.
	 */
	public GenericCSVImportStepDTO()
	{
		super();
	}
