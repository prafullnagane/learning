...
public class LinkTest extends HybrisJUnit4TransactionalTest
{
	...
	public void testOrderings() throws ConsistencyCheckException
	{
		...
		assertNotNull(ug1 = userManager.createUserGroup("ug1"));
		assertNotNull(ug2 = userManager.createUserGroup("ug2"));
		assertNotNull(ug3 = userManager.createUserGroup("ug3"));

		assertNotNull(employee1 = userManager.createEmployee("e1"));
		assertNotNull(employee2 = userManager.createEmployee("e2"));
		assertNotNull(employee3 = userManager.createEmployee("e3"));
	...
	public void testSetAllLinkedItems() throws ConsistencyCheckException
	{
		...
		assertNotNull(language1 = C2LManager.getInstance().createLanguage("l1"));
		assertNotNull(language2 = C2LManager.getInstance().createLanguage("l2"));
	...
	public void testLocalizedLinks() throws ConsistencyCheckException
	{
		...
		assertNotNull(product = ProductManager.getInstance().createProduct("plnk"));
		assertNotNull(media1 = MediaManager.getInstance().createMedia("lnkM1"));
		assertNotNull(media2 = MediaManager.getInstance().createMedia("lnkM2"));
		assertNotNull(media3 = MediaManager.getInstance().createMedia("lnkM3"));

		final String QUALI = "blahFasel";

		Language language1, language2, language3;
		assertNotNull(language1 = C2LManager.getInstance().createLanguage("la1"));
		assertNotNull(language2 = C2LManager.getInstance().createLanguage("la2"));
		assertNotNull(language3 = C2LManager.getInstance().createLanguage("la3"));
