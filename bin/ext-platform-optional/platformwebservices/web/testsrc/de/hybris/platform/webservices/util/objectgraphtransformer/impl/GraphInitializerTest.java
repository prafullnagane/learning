...
public class GraphInitializerTest
{
	...
	public void testPropertyConfigLookup3()
	{
		...
		final NodeMapping nm = graph.getNodeMapping(InitGraph1Sub.class);

		final Map<String, PropertyMapping> pMapping = new LinkedHashMap<String, PropertyMapping>(nm.getPropertyMappings());
