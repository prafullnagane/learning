...
public class ProductResourceTest extends AbstractWebServicesTest
{
	...
	public void setUpProducts() throws ConsistencyCheckException, JaloBusinessException
	{
		...
		//setup variants
		final VariantType vt = createVariantType();
		VariantsManager.getInstance().setVariantType(testProduct, vt);
		...
		createVariant(vt, testProduct, variantAttributes[0][0], variantAttributes[0][1], variantAttributes[0][2], version);
		createVariant(vt, testProduct, variantAttributes[1][0], variantAttributes[1][1], variantAttributes[1][2], version);
