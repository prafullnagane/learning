...
/**
 * Generated resource class for type RemoveCatalogVersionCronJob first defined at extension catalog
 */
@SuppressWarnings("all")
public class RemoveCatalogVersionCronJobResource extends AbstractYResource<RemoveCatalogVersionCronJobModel>
{
	/**
	 * <i>Generated constructor</i> - for generic creation.
	 */
	public RemoveCatalogVersionCronJobResource()
	{
	 ...
	 */
	@DELETE
	public Response deleteRemoveCatalogVersionCronJob()
	{
	 ...
	 */
	@GET
	public Response getRemoveCatalogVersionCronJob()
	{
	 ...
	 */
	public RemoveCatalogVersionCronJobModel getRemoveCatalogVersionCronJobModel()
	{
	 ...
	 */
	@PUT
	public Response putRemoveCatalogVersionCronJob(final RemoveCatalogVersionCronJobDTO dto)
	{
		return createPutResponse(dto).build();
	}
	
	/**
	 * Gets the {@link RemoveCatalogVersionCronJobModel} resource which is addressed by current resource request.
	 * @see de.hybris.platform.webservices.AbstractYResource#readResource(String)
	 */
	@Override
	protected RemoveCatalogVersionCronJobModel readResource(final String resourceId) throws Exception
	{
		RemoveCatalogVersionCronJobModel model = new RemoveCatalogVersionCronJobModel();
		model.setCode(resourceId);
		return (RemoveCatalogVersionCronJobModel) readResourceInternal(model);
	}
	
	/**
	 * Convenience method which just delegates to {@link #setResourceValue(RemoveCatalogVersionCronJobModel)}
	 */
	public void setRemoveCatalogVersionCronJobModel(final RemoveCatalogVersionCronJobModel value)
	{
