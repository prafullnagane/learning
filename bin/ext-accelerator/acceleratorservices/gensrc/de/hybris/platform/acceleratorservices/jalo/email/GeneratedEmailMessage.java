...
public abstract class GeneratedEmailMessage extends GenericItem
{
	...
	/** Qualifier of the <code>EmailMessage.fromAddressPOS</code> attribute **/
	public static final String FROMADDRESSPOS = "fromAddressPOS";
	...
	**/
	...
	static
	{
		...
		tmp.put(FROMADDRESSPOS, AttributeMode.INITIAL);
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>EmailMessage.fromAddressPOS</code> attribute.
	 * @return the fromAddressPOS
	 */
	 Integer getFromAddressPOS(final SessionContext ctx)
	{
		return (Integer)getProperty( ctx, FROMADDRESSPOS);
	}
	 ...
	 * @return the fromAddressPOS
	 */
	 Integer getFromAddressPOS()
	{
		return getFromAddressPOS( getSession().getSessionContext() );
	}
	 ...
	 * @return the fromAddressPOS
	 */
	 int getFromAddressPOSAsPrimitive(final SessionContext ctx)
	{
		Integer value = getFromAddressPOS( ctx );
	 ...
	 * @return the fromAddressPOS
	 */
	 int getFromAddressPOSAsPrimitive()
	{
		return getFromAddressPOSAsPrimitive( getSession().getSessionContext() );
	}
	
	/**
	 * <i>Generated method</i> - Setter of the <code>EmailMessage.fromAddressPOS</code> attribute. 
	 * @param value the fromAddressPOS
	 */
	 void setFromAddressPOS(final SessionContext ctx, final Integer value)
	{
		setProperty(ctx, FROMADDRESSPOS,value);
	}
	 ...
	 * @param value the fromAddressPOS
	 */
	 void setFromAddressPOS(final Integer value)
	{
		setFromAddressPOS( getSession().getSessionContext(), value );
	}
	 ...
	 * @param value the fromAddressPOS
	 */
	 void setFromAddressPOS(final SessionContext ctx, final int value)
	{
		setFromAddressPOS( ctx,Integer.valueOf( value ) );
	}
	 ...
	 * @param value the fromAddressPOS
	 */
	 void setFromAddressPOS(final int value)
	{
		setFromAddressPOS( getSession().getSessionContext(), value );
	}
