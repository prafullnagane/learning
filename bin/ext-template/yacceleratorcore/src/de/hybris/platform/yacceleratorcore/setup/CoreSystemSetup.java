...
public class CoreSystemSetup extends AbstractSystemSetup
{
	...
	private class ImportCatalogAwareDataStrategy
	{
		...
		private void createAndActivateSolrIndex(final String storeName)
		{
			...
			importImpexFile(context, "/yacceleratorcore/import/stores/" + storeName + "/solr.impex");

			createSolrIndexerCronJobs(storeName + "Index");

			importImpexFile(context, "/yacceleratorcore/import/stores/" + storeName + "/solrtrigger.impex");
		...
		private void createStore(final String storeName)
		{
			...
			importImpexFile(context, "/yacceleratorcore/import/stores/" + storeName + "/store.impex");
			importImpexFile(context, "/yacceleratorcore/import/stores/" + storeName + "/site.impex");
		...
		private void createContentCatalog(final String contentCatalogName)
		{
			...
			importImpexFile(context, "/yacceleratorcore/import/contentCatalogs/" + contentCatalogName
		...
		private void createProductCatalog(final String productCatalogName)
		{
			...
			importImpexFile(context, "/yacceleratorcore/import/productCatalogs/" + productCatalogName
