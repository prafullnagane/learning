...
public class MediaIntegrationTest extends HybrisJUnit4TransactionalTest
{
	...
	private static class MediaAssert extends GenericAssert<MediaAssert, Media>
	{
		public MediaAssert(final Media actual)
		{
			super(MediaAssert.class, actual);
		}

		public static MediaAssert assertThat(final Media actual)
		{
			return new MediaAssert(actual);
		}

		public MediaAssert hasSameMetaDataAs(final Media sourceMedia)
		{
			Assertions.assertThat(actual.getDataPK()).isEqualTo(sourceMedia.getDataPK());
			Assertions.assertThat(actual.getMime()).isEqualTo(sourceMedia.getMime());
			Assertions.assertThat(actual.getLocation()).isEqualTo(sourceMedia.getLocation());
			Assertions.assertThat(actual.getLocationHash()).isEqualTo(sourceMedia.getLocationHash());
			Assertions.assertThat(actual.getRealFileName()).isEqualTo(sourceMedia.getRealFileName());
			Assertions.assertThat(actual.getSize()).isEqualTo(sourceMedia.getSize());
			return this;
		}
	}
}
