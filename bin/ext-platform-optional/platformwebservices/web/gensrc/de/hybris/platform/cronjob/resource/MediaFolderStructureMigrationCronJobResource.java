...
import de.hybris.platform.cronjob.dto.MediaFolderStructureMigrationCronJobDTO;
...
/**
 * Generated resource class for type MediaFolderStructureMigrationCronJob first defined at extension processing
 */
@SuppressWarnings("all")
public class MediaFolderStructureMigrationCronJobResource extends AbstractYResource<MediaFolderStructureMigrationCronJobModel>
{
	/**
	 * <i>Generated constructor</i> - for generic creation.
	 */
	public MediaFolderStructureMigrationCronJobResource()
	{
	 ...
	 */
	@DELETE
	public Response deleteMediaFolderStructureMigrationCronJob()
	{
	 ...
	 */
	@GET
	public Response getMediaFolderStructureMigrationCronJob()
	{
	 ...
	 */
	public MediaFolderStructureMigrationCronJobModel getMediaFolderStructureMigrationCronJobModel()
	{
	 ...
	 */
	@PUT
	public Response putMediaFolderStructureMigrationCronJob(final MediaFolderStructureMigrationCronJobDTO dto)
	{
		return createPutResponse(dto).build();
	}
	
	/**
	 * Gets the {@link MediaFolderStructureMigrationCronJobModel} resource which is addressed by current resource request.
	 * @see de.hybris.platform.webservices.AbstractYResource#readResource(String)
	 */
	@Override
	protected MediaFolderStructureMigrationCronJobModel readResource(final String resourceId) throws Exception
	{
		MediaFolderStructureMigrationCronJobModel model = new MediaFolderStructureMigrationCronJobModel();
		model.setCode(resourceId);
		return (MediaFolderStructureMigrationCronJobModel) readResourceInternal(model);
	}
	
	/**
	 * Convenience method which just delegates to {@link #setResourceValue(MediaFolderStructureMigrationCronJobModel)}
	 */
	public void setMediaFolderStructureMigrationCronJobModel(final MediaFolderStructureMigrationCronJobModel value)
	{
