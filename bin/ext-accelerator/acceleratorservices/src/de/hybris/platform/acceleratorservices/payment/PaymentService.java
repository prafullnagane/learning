...
public interface PaymentService
{
	 ...
	 */
	PaymentData beginHopCreatePaymentSubscription(String siteName, String responseUrl, String merchantCallbackUrl, CustomerModel customerModel, CreditCardPaymentInfoModel cardInfo, AddressModel paymentAddress)
			throws IllegalArgumentException;
	 ...
	 * @throws IllegalArgumentException
	 */
	PaymentData beginSopCreatePaymentSubscription(String siteName, String responseUrl, String merchantCallbackUrl, CustomerModel customerModel, CreditCardPaymentInfoModel cardInfo, AddressModel paymentAddress)
			throws IllegalArgumentException;
	...
	/**
	 * This method creates a subscription internally with the result parameters obtained from the provider's Silent
	 * Order Post. Only basic customer information and a subscription id is stored internally. All customer
	 * information is stored on the provider's system including credit card number and security code. The subscription
	 * id is used for future lookup for obtaining the customer's credit card details.
	 *
	 * @param customerModel
	 *           - The Customer details.
	 * @param saveInAccount
	...
	/**
	 * This method attempts to validate the payment info with a given subscriptionId. Validation should only pass if both the
	 * payment info and the valid subscription exists for this subscriptionId.
	 *
	 * @param parameters
	...
	void handleFraudUpdate(Map<String, String> parameters);
	 ...
	 * 
	 */
	public void setPaymentTransactionReviewResult(final PaymentTransactionEntryModel reviewDecisionEntry, final String orderCode);
}
