...
<div id="header">
	...
	<div class="topNav">
	    <ul class="addonTob">
	        <li>
	            <a href="#" class="">Free Shipping</a>
	        </li>
	        <li>
	            <a href="#" class="">Free Exchanges / Returns</a>
	        </li>
	        <li class="deliveryLoc">
	            <a href="" class="deliveryLoc">Delivery to Over 5000 Location (Check)</a>
	        </li>
	        <li>
	            <a href="#" class="">Order Information</a>
	        </li>
	        <li>
	            <a href="#" class="">Contact us / Feedback</a>
	        </li>
	        <li>
	            <a href="#">Blog</a>
	        </li>
	        <li class="rt">
	            <div class="helpline">
	                <span class="txt">May We Help?</span>
	            </div>
	        </li>
	    </ul>
	    <div class="clear"></div>
