...
/**
 * Generated resource class for type LDIFImportCronJob first defined at extension ldap
 */
@SuppressWarnings("all")
public class LDIFImportCronJobResource extends AbstractYResource<LDIFImportCronJobModel>
{
	/**
	 * <i>Generated constructor</i> - for generic creation.
	 */
	public LDIFImportCronJobResource()
	{
	 ...
	 */
	@DELETE
	public Response deleteLDIFImportCronJob()
	{
	 ...
	 */
	@GET
	public Response getLDIFImportCronJob()
	{
	 ...
	 */
	public LDIFImportCronJobModel getLDIFImportCronJobModel()
	{
	 ...
	 */
	@PUT
	public Response putLDIFImportCronJob(final LDIFImportCronJobDTO dto)
	{
		return createPutResponse(dto).build();
	}
	
	/**
	 * Gets the {@link LDIFImportCronJobModel} resource which is addressed by current resource request.
	 * @see de.hybris.platform.webservices.AbstractYResource#readResource(String)
	 */
	@Override
	protected LDIFImportCronJobModel readResource(final String resourceId) throws Exception
	{
		LDIFImportCronJobModel model = new LDIFImportCronJobModel();
		model.setCode(resourceId);
		return (LDIFImportCronJobModel) readResourceInternal(model);
	}
	
	/**
	 * Convenience method which just delegates to {@link #setResourceValue(LDIFImportCronJobModel)}
	 */
	public void setLDIFImportCronJobModel(final LDIFImportCronJobModel value)
	{
