...
import de.hybris.platform.orderscheduling.dto.OrderScheduleCronJobDTO;
...
/**
 * Generated resource class for type OrderScheduleCronJob first defined at extension basecommerce
 */
@SuppressWarnings("all")
public class OrderScheduleCronJobResource extends AbstractYResource<OrderScheduleCronJobModel>
{
	/**
	 * <i>Generated constructor</i> - for generic creation.
	 */
	public OrderScheduleCronJobResource()
	{
	 ...
	 */
	@DELETE
	public Response deleteOrderScheduleCronJob()
	{
	 ...
	 */
	@GET
	public Response getOrderScheduleCronJob()
	{
	 ...
	 */
	public OrderScheduleCronJobModel getOrderScheduleCronJobModel()
	{
	 ...
	 */
	@PUT
	public Response putOrderScheduleCronJob(final OrderScheduleCronJobDTO dto)
	{
		return createPutResponse(dto).build();
	}
	
	/**
	 * Gets the {@link OrderScheduleCronJobModel} resource which is addressed by current resource request.
	 * @see de.hybris.platform.webservices.AbstractYResource#readResource(String)
	 */
	@Override
	protected OrderScheduleCronJobModel readResource(final String resourceId) throws Exception
	{
		OrderScheduleCronJobModel model = new OrderScheduleCronJobModel();
		model.setCode(resourceId);
		return (OrderScheduleCronJobModel) readResourceInternal(model);
	}
	
	/**
	 * Convenience method which just delegates to {@link #setResourceValue(OrderScheduleCronJobModel)}
	 */
	public void setOrderScheduleCronJobModel(final OrderScheduleCronJobModel value)
	{
