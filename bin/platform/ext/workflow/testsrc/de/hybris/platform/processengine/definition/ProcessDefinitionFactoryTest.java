...
public class ProcessDefinitionFactoryTest extends ServicelayerBaseTest
{
	...
	public void setUp()
	{
		...
		processDefinitionFactoryStub.setApplicationContext(new GenericApplicationContext());
	}
	...
	{
		final String processName = this.processDefinitionFactoryStub.add(url);
		assertNotNull("defFac.getProcessDefinition", this.processDefinitionFactoryStub.getProcessDefinition(processName));
	}
