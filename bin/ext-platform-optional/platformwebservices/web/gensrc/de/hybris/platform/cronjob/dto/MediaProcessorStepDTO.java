...
@GraphNode(target = MediaProcessorStepModel.class, factory = GenericNodeFactory.class, uidProperties="code")
@XmlRootElement(name = "mediaprocessorstep")
public class MediaProcessorStepDTO extends StepDTO
{
	/**
	 * <i>Generated constructor</i> - for generic creation.
	 */
	public MediaProcessorStepDTO()
	{
		super();
	}
