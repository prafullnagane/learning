...
public class DefaultEmailTemplateTranslationStrategy implements EmailTemplateTranslationStrategy
{
	...
	@Override
	public Map<String, Object> translateMessagesForTemplate(final RendererTemplateModel renderTemplate)
	{
		//Get current locale.
		final String currentLanIso = getCommonI18NService().getCurrentLanguage().getIsocode();

		//Get the location of the properties file
		final List<String> propertiesRootPaths = getPropertiesRootPath(renderTemplate, currentLanIso);
