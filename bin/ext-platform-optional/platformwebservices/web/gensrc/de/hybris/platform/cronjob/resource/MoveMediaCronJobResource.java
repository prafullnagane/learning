...
/**
 * Generated resource class for type MoveMediaCronJob first defined at extension processing
 */
@SuppressWarnings("all")
public class MoveMediaCronJobResource extends AbstractYResource<MoveMediaCronJobModel>
{
	/**
	 * <i>Generated constructor</i> - for generic creation.
	 */
	public MoveMediaCronJobResource()
	{
	 ...
	 */
	@DELETE
	public Response deleteMoveMediaCronJob()
	{
	 ...
	 */
	@GET
	public Response getMoveMediaCronJob()
	{
	 ...
	 */
	public MoveMediaCronJobModel getMoveMediaCronJobModel()
	{
	 ...
	 */
	@PUT
	public Response putMoveMediaCronJob(final MoveMediaCronJobDTO dto)
	{
		return createPutResponse(dto).build();
	}
	
	/**
	 * Gets the {@link MoveMediaCronJobModel} resource which is addressed by current resource request.
	 * @see de.hybris.platform.webservices.AbstractYResource#readResource(String)
	 */
	@Override
	protected MoveMediaCronJobModel readResource(final String resourceId) throws Exception
	{
		MoveMediaCronJobModel model = new MoveMediaCronJobModel();
		model.setCode(resourceId);
		return (MoveMediaCronJobModel) readResourceInternal(model);
	}
	
	/**
	 * Convenience method which just delegates to {@link #setResourceValue(MoveMediaCronJobModel)}
	 */
	public void setMoveMediaCronJobModel(final MoveMediaCronJobModel value)
	{
