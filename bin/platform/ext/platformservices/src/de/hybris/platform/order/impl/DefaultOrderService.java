...
public class DefaultOrderService extends DefaultAbstractOrderService<OrderModel, OrderEntryModel> implements OrderService
{
	...
	{
		LOG.warn("Usage of deprecated placeOrder(...) method. ");
	...
	{
		LOG.warn("Using deprecated calculateOrder() method!");
	...
	{
		LOG.warn("Injecting deprecated Place Order Strategy!");
	...
	{
		LOG.warn("Injecting deprecated OrderCalcuation strategy!");
