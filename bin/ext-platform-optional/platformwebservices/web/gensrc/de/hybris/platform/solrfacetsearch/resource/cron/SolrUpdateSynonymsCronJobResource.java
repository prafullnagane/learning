...
/**
 * Generated resource class for type SolrUpdateSynonymsCronJob first defined at extension solrfacetsearch
 */
@SuppressWarnings("all")
public class SolrUpdateSynonymsCronJobResource extends AbstractYResource<SolrUpdateSynonymsCronJobModel>
{
	/**
	 * <i>Generated constructor</i> - for generic creation.
	 */
	public SolrUpdateSynonymsCronJobResource()
	{
	 ...
	 */
	@DELETE
	public Response deleteSolrUpdateSynonymsCronJob()
	{
	 ...
	 */
	@GET
	public Response getSolrUpdateSynonymsCronJob()
	{
	 ...
	 */
	public SolrUpdateSynonymsCronJobModel getSolrUpdateSynonymsCronJobModel()
	{
	 ...
	 */
	@PUT
	public Response putSolrUpdateSynonymsCronJob(final SolrUpdateSynonymsCronJobDTO dto)
	{
		return createPutResponse(dto).build();
	}
	
	/**
	 * Gets the {@link SolrUpdateSynonymsCronJobModel} resource which is addressed by current resource request.
	 * @see de.hybris.platform.webservices.AbstractYResource#readResource(String)
	 */
	@Override
	protected SolrUpdateSynonymsCronJobModel readResource(final String resourceId) throws Exception
	{
		SolrUpdateSynonymsCronJobModel model = new SolrUpdateSynonymsCronJobModel();
		model.setCode(resourceId);
		return (SolrUpdateSynonymsCronJobModel) readResourceInternal(model);
	}
	
	/**
	 * Convenience method which just delegates to {@link #setResourceValue(SolrUpdateSynonymsCronJobModel)}
	 */
	public void setSolrUpdateSynonymsCronJobModel(final SolrUpdateSynonymsCronJobModel value)
	{
