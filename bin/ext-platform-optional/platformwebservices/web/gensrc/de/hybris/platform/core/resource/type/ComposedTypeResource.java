...
/**
 * Generated resource class for type ComposedType first defined at extension core
 */
@SuppressWarnings("all")
public class ComposedTypeResource extends AbstractYResource<ComposedTypeModel>
{
	/**
	 * <i>Generated constructor</i> - for generic creation.
	 */
	public ComposedTypeResource()
	{
		super("ComposedType");
	}
	 ...
	 */
	@DELETE
	public Response deleteComposedType()
	{
	 ...
	 */
	@GET
	public Response getComposedType()
	{
	 ...
	 */
	@PUT
	public Response putComposedType(final ComposedTypeDTO dto)
	{
		return createPutResponse(dto).build();
	}
	
	/**
	 * Gets the {@link ComposedTypeModel} resource which is addressed by current resource request.
	 * @see de.hybris.platform.webservices.AbstractYResource#readResource(String)
	 */
	@Override
	protected ComposedTypeModel readResource(final String resourceId) throws Exception
	{
		ComposedTypeModel model = new ComposedTypeModel();
		model.setCode(resourceId);
		return (ComposedTypeModel) readResourceInternal(model);
	}
	
	/**
	 * Convenience method which just delegates to {@link #setResourceValue(ComposedTypeModel)}
	 */
	public void setComposedTypeModel(final ComposedTypeModel value)
	{
