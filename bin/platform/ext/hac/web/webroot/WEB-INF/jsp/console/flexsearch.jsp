...
<body>
			...
			<div id="tabsNoSidebar" class="marginBottom">
				...
				<div id="tabs-1">
					<form:form method="post" action="${url}" commandName="flexQueryForm">
						<fieldset>
							...
							<div id="flexibleSearchQueryWrapper" class="textarea-container" data-stylesheetUrl="<c:url value="/static/css/codemirror/sqlcolors.css" />" data-pathUrl="<c:url value="/static/js/codemirror/" />">
								<form:textarea path="flexibleSearchQuery" cols="50" rows="8" data-errormsg="${errorMsg}"/>
							</div>
						</fieldset>
						...
						<fieldset>
							...
							<p>
								<div style="float:left;margin-top:7px">
									<input type="checkbox" id="commitCheckbox1"/>
								</div>
				...
				<div id="tabs-2">
						...
						<fieldset>
							...
							<div id="sqlQueryWrapper" class="textarea-container" data-stylesheetUrl="<c:url value="/static/css/codemirror/sqlcolors.css" />" data-pathUrl="<c:url value="/static/js/codemirror/" />">
						...
						<fieldset>
							...
							<p>
								<div style="float:left;margin-top:7px">
									<input type="checkbox" class="checkbox" id="commitCheckbox2"/>
								</div>
				...
				<div id="tabs-5" historyMax="${historyMax}">
	...
	<div class="span-6 last" id="sidebar">
		...
		<div class="prepend-top" id="recent-reviews">
			...
			<div class="box">
				<ul>
					<li> <a href="https://wiki.hybris.com/display/release4/Flexible+Search" target="_blank"  class="quiet" >FlexibleSearch</a> </li>
				</ul>
			</div>
		</div>
	</div>
