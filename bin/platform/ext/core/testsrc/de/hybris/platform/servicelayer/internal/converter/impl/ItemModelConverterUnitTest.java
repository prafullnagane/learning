...
public class ItemModelConverterUnitTest
{
	 ...
	 * 
	 */
	private void assertValid(final ItemModelConverter converter, final Foo model, String attribute, Object value)
	{
	...
	private void assertNotValid(final ItemModelConverter converter, final Foo model, String attribute, Object value)
	{
		final ModelAttributeInfo attributeFoo = createAttributeInfo(attribute);
	 ...
	 * 
	 */
	private ModelAttributeInfo createAttributeInfo(String attribute)
	{
	...
	class TestModelAttributeInfo extends ModelAttributeInfo
	{
		...
		public TestModelAttributeInfo(String qualifier)
		{
			super(qualifier);
	...
	class Bar extends Boo
	{
		...
		Bar(String bar, String boo, String foo)
		{
			super(boo, foo);
			this._bar = bar;
		}
