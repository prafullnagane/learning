...
/**
 * Generated resource class for type ExportDataCronJob first defined at extension acceleratorservices
 */
@SuppressWarnings("all")
public class ExportDataCronJobResource extends AbstractYResource<ExportDataCronJobModel>
{
	/**
	 * <i>Generated constructor</i> - for generic creation.
	 */
	public ExportDataCronJobResource()
	{
	 ...
	 */
	@DELETE
	public Response deleteExportDataCronJob()
	{
	 ...
	 */
	@GET
	public Response getExportDataCronJob()
	{
	 ...
	 */
	public ExportDataCronJobModel getExportDataCronJobModel()
	{
	 ...
	 */
	@PUT
	public Response putExportDataCronJob(final ExportDataCronJobDTO dto)
	{
		return createPutResponse(dto).build();
	}
	
	/**
	 * Gets the {@link ExportDataCronJobModel} resource which is addressed by current resource request.
	 * @see de.hybris.platform.webservices.AbstractYResource#readResource(String)
	 */
	@Override
	protected ExportDataCronJobModel readResource(final String resourceId) throws Exception
	{
		ExportDataCronJobModel model = new ExportDataCronJobModel();
		model.setCode(resourceId);
		return (ExportDataCronJobModel) readResourceInternal(model);
	}
	
	/**
	 * Convenience method which just delegates to {@link #setResourceValue(ExportDataCronJobModel)}
	 */
	public void setExportDataCronJobModel(final ExportDataCronJobModel value)
	{
