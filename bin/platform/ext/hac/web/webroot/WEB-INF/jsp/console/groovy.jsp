	...
	<body>	
		<div class="prepend-top span-17 colborder" id="content" encryptUrl="<c:url value="/console/encrypt" />" decryptUrl="<c:url value="/console/decrypt" />">
			...
			<div class="marginLeft">
				<h2>Groovy Web Console (${groovyVersion})</h2>
				...
				<div id="tabsNoSidebar" class="marginBottom">
					...
					<div id="tabs-edit">
						...
						<div id="textarea-container" class="border">
							...
							<textarea id="script" name="script" cols="140" rows="40" data-stylesheetUrl="<c:url value="/static/css/codemirror/groovycolors.css" />" data-pathUrl="<c:url value="/static/js/codemirror/" />">ctx.beanDefinitionNames.each {
								println it
								}
								return "Groovy Rocks!"
							</textarea>
						...
						<div id="buttons">
							...
							<button id="executeButton" style="float:right" data-executorUrl="<c:url value="/console/groovy/execute" />">Execute</button>
						</div>
					...
					<div id="tabs-history" cookieName="GroovyShellHistory" historyMax="${historyMax}">
		...
		<div class="span-6 last" id="sidebar">
			<div class="prepend-top" id="recent-reviews">
				...
				<div class="box">
					<div class="quiet">
					 This page provides the Groovy console. It comes with implicit variables:<br><br>
						<ul>
