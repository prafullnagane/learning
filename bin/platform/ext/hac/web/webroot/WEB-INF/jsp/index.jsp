...
<!--  script type="text/javascript" src="<c:url value="/static/js/jsapi.js"/>"></script>-->
	...
	<div class="span-6 last" id="sidebar">
		<div class="prepend-top">
			...
			<div class="box">
				<div class="quiet">
					<ul>
						<li><a href="https://wiki.hybris.com/display/release4/Administration+Console" target="_blank" class="quiet">hybris Administration Console - End User Guide</a> </li>
					</ul>
				</div>
			</div>
		</div>
