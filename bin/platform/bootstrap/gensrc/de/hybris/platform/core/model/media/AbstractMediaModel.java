...
public class AbstractMediaModel extends ItemModel
{
	...
	/**
	 * <i>Generated method</i> - Initial setter of <code>AbstractMedia.dataPK</code> attribute defined at extension <code>core</code>. Can only be used at creation of model - before first save.  
	 *  
	 * @param value the dataPK - PK of the referenced data file.
	 */
	protected void setDataPK(final Long value)
	{
	...
	/**
	 * <i>Generated method</i> - Initial setter of <code>AbstractMedia.size</code> attribute defined at extension <code>core</code>. Can only be used at creation of model - before first save.  
	 *  
	 * @param value the size - Size of referenced data file.
	 */
	protected void setSize(final Long value)
	{
