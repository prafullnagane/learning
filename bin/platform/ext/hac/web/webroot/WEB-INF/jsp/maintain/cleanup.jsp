	...
	<body>
			...
			<div class="span-6 last" id="sidebar1">
				<div class="prepend-top">
					...
					<div class="box">
						<ul>
							<li> <a href="https://wiki.hybris.com/display/release4/Clean+All+Orphaned+Types" target="_blank" class="quiet" >Cleanup Type System</a> </li>
						</ul>
					</div>
				</div>
			</div>
			<div class="span-6 last" id="sidebar2">
				<div class="prepend-top">
					...
					<div class="box">
						<ul>
							<li> <a href="https://wiki.hybris.com/display/release4/Lucene+Search" target="_blank" class="quiet" >lucenesearch Extension - Technical Guide</a> </li>
						</ul>
					</div>
				</div>
			</div>
