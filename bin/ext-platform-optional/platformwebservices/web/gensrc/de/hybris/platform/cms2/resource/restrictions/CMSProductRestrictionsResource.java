...
import de.hybris.platform.cms2.dto.restrictions.CMSProductRestrictionsDTO;
...
/**
 * Generated REST root resource for a collection of elements of  type CMSProductRestriction defined at extension cms2 Allowed methods: GET, POST, PUT, DELETE, HEADER  
 */
@SuppressWarnings("all")
@Path("/cmsproductrestrictions")
public class CMSProductRestrictionsResource extends AbstractCollectionResource <Collection<CMSProductRestrictionModel>>
{
	/**
	 ...
	 */
	public Collection<CMSProductRestrictionModel> getCMSProductRestrictionsCollection()
	{
	 ...
	 */
	public void setCMSProductRestrictionsCollection(final Collection<CMSProductRestrictionModel> value)
	{
