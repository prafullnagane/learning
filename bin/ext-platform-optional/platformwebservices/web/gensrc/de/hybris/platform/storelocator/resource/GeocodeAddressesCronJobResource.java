...
/**
 * Generated resource class for type GeocodeAddressesCronJob first defined at extension basecommerce
 */
@SuppressWarnings("all")
public class GeocodeAddressesCronJobResource extends AbstractYResource<GeocodeAddressesCronJobModel>
{
	/**
	 * <i>Generated constructor</i> - for generic creation.
	 */
	public GeocodeAddressesCronJobResource()
	{
	 ...
	 */
	@DELETE
	public Response deleteGeocodeAddressesCronJob()
	{
	 ...
	 */
	@GET
	public Response getGeocodeAddressesCronJob()
	{
	 ...
	 */
	public GeocodeAddressesCronJobModel getGeocodeAddressesCronJobModel()
	{
	 ...
	 */
	@PUT
	public Response putGeocodeAddressesCronJob(final GeocodeAddressesCronJobDTO dto)
	{
		return createPutResponse(dto).build();
	}
	
	/**
	 * Gets the {@link GeocodeAddressesCronJobModel} resource which is addressed by current resource request.
	 * @see de.hybris.platform.webservices.AbstractYResource#readResource(String)
	 */
	@Override
	protected GeocodeAddressesCronJobModel readResource(final String resourceId) throws Exception
	{
		GeocodeAddressesCronJobModel model = new GeocodeAddressesCronJobModel();
		model.setCode(resourceId);
		return (GeocodeAddressesCronJobModel) readResourceInternal(model);
	}
	
	/**
	 * Convenience method which just delegates to {@link #setResourceValue(GeocodeAddressesCronJobModel)}
	 */
	public void setGeocodeAddressesCronJobModel(final GeocodeAddressesCronJobModel value)
	{
