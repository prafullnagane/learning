...
/**
 * Generated resource class for type ClassAttributeAssignment first defined at extension catalog
 */
@SuppressWarnings("all")
public class ClassAttributeAssignmentResource extends AbstractYResource<ClassAttributeAssignmentModel>
{
	/**
	 * <i>Generated constructor</i> - for generic creation.
	 */
	public ClassAttributeAssignmentResource()
	{
	 ...
	 */
	@DELETE
	public Response deleteClassAttributeAssignment()
	{
	 ...
	 */
	@GET
	public Response getClassAttributeAssignment()
	{
	 ...
	 */
	@PUT
	public Response putClassAttributeAssignment(final ClassAttributeAssignmentDTO dto)
	{
		return createPutResponse(dto).build();
	}
	
	/**
	 * Gets the {@link ClassAttributeAssignmentModel} resource which is addressed by current resource request.
	 * @see de.hybris.platform.webservices.AbstractYResource#readResource(String)
	 */
	@Override
	protected ClassAttributeAssignmentModel readResource(final String resourceId) throws Exception
	{
		return serviceLocator.getModelService().get(PK.parse(resourceId));
	}
	
	/**
	 * Convenience method which just delegates to {@link #setResourceValue(ClassAttributeAssignmentModel)}
	 */
	public void setClassAttributeAssignmentModel(final ClassAttributeAssignmentModel value)
	{
