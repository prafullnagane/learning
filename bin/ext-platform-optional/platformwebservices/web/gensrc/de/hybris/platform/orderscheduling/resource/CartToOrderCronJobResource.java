...
/**
 * Generated resource class for type CartToOrderCronJob first defined at extension basecommerce
 */
@SuppressWarnings("all")
public class CartToOrderCronJobResource extends AbstractYResource<CartToOrderCronJobModel>
{
	/**
	 * <i>Generated constructor</i> - for generic creation.
	 */
	public CartToOrderCronJobResource()
	{
	 ...
	 */
	@DELETE
	public Response deleteCartToOrderCronJob()
	{
	 ...
	 */
	@GET
	public Response getCartToOrderCronJob()
	{
	 ...
	 */
	public CartToOrderCronJobModel getCartToOrderCronJobModel()
	{
	 ...
	 */
	@PUT
	public Response putCartToOrderCronJob(final CartToOrderCronJobDTO dto)
	{
		return createPutResponse(dto).build();
	}
	
	/**
	 * Gets the {@link CartToOrderCronJobModel} resource which is addressed by current resource request.
	 * @see de.hybris.platform.webservices.AbstractYResource#readResource(String)
	 */
	@Override
	protected CartToOrderCronJobModel readResource(final String resourceId) throws Exception
	{
		CartToOrderCronJobModel model = new CartToOrderCronJobModel();
		model.setCode(resourceId);
		return (CartToOrderCronJobModel) readResourceInternal(model);
	}
	
	/**
	 * Convenience method which just delegates to {@link #setResourceValue(CartToOrderCronJobModel)}
	 */
	public void setCartToOrderCronJobModel(final CartToOrderCronJobModel value)
	{
