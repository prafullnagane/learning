...
<div class="prod_list span-5 ${hasPromotion ? 'prod_list_has_promotion' : ''}">
	<ycommerce:testId code="test_searchPage_wholeProduct">
		...
		<div class="cart">
			...
			<ycommerce:testId code="searchPage_addToCart_button_${product.code}">
				...
				<form id="addToCartForm${product.code}" action="<c:url value="/cart/add"/>" method="post" class="add_to_cart_form pull-right">
