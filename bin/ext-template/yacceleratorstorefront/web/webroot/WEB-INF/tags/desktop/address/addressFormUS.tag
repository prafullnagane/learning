<%@ attribute name="states" required="true" type="java.util.List"%>
...
<form:form method="post" commandName="addressForm" id="USaddressForm">
		...
		<formElement:formSelectBox idKey="address.region" labelKey="address.state" path="regionIso" mandatory="true" skipBlank="false" skipBlankMessageKey="address.selectState" items="${states}" itemValue="isocode" selectedValue="${addressForm.regionIso}"/>
