...
/**
 * Generated resource class for type MediaProcessCronJob first defined at extension processing
 */
@SuppressWarnings("all")
public class MediaProcessCronJobResource extends AbstractYResource<MediaProcessCronJobModel>
{
	/**
	 * <i>Generated constructor</i> - for generic creation.
	 */
	public MediaProcessCronJobResource()
	{
	 ...
	 */
	@DELETE
	public Response deleteMediaProcessCronJob()
	{
	 ...
	 */
	@GET
	public Response getMediaProcessCronJob()
	{
	 ...
	 */
	public MediaProcessCronJobModel getMediaProcessCronJobModel()
	{
	 ...
	 */
	@PUT
	public Response putMediaProcessCronJob(final MediaProcessCronJobDTO dto)
	{
		return createPutResponse(dto).build();
	}
	
	/**
	 * Gets the {@link MediaProcessCronJobModel} resource which is addressed by current resource request.
	 * @see de.hybris.platform.webservices.AbstractYResource#readResource(String)
	 */
	@Override
	protected MediaProcessCronJobModel readResource(final String resourceId) throws Exception
	{
		MediaProcessCronJobModel model = new MediaProcessCronJobModel();
		model.setCode(resourceId);
		return (MediaProcessCronJobModel) readResourceInternal(model);
	}
	
	/**
	 * Convenience method which just delegates to {@link #setResourceValue(MediaProcessCronJobModel)}
	 */
	public void setMediaProcessCronJobModel(final MediaProcessCronJobModel value)
	{
