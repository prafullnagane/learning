...
import de.hybris.platform.catalog.resource.classification.ClassificationAttributeResource;
...
/**
 * Generated resource class for type ClassificationSystemVersion first defined at extension catalog
 */
@SuppressWarnings("all")
public class ClassificationSystemVersionResource extends AbstractYResource<ClassificationSystemVersionModel>
{
	/**
	 * <i>Generated constructor</i> - for generic creation.
	 */
	public ClassificationSystemVersionResource()
	{
	 ...
	 */
	@DELETE
	public Response deleteClassificationSystemVersion()
	{
	...
	/**
	 *  Generated getter for sub resource of type {@link ClassificationAttributeResource} for current root resource 
	 */
	@Path("/classificationattributes/{classificationattribute}")
	public AbstractYResource getClassificationAttributeResource(@PathParam("classificationattribute")  final String resourceKey)
	{
		final ClassificationAttributeResource  resource  = resourceCtx.getResource(ClassificationAttributeResource.class);
		resource.setResourceId(resourceKey );
		resource.setParentResource(this);
		passUniqueMember(resource);
		return resource;
	 ...
	 */
	@Path("/classificationattributeunits/{classificationattributeunit}")
	 ...
	 */
	@Path("/classificationattributevalues/{classificationattributevalue}")
	 ...
	 */
	@GET
	public Response getClassificationSystemVersion()
	{
	 ...
	 */
	public ClassificationSystemVersionModel getClassificationSystemVersionModel()
	{
	 ...
	 */
	@PUT
	public Response putClassificationSystemVersion(final ClassificationSystemVersionDTO dto)
	{
		return createPutResponse(dto).build();
	}
	
	/**
	 * Gets the {@link ClassificationSystemVersionModel} resource which is addressed by current resource request.
	 * @see de.hybris.platform.webservices.AbstractYResource#readResource(String)
	 */
	@Override
	protected ClassificationSystemVersionModel readResource(final String resourceId) throws Exception
	{
		ClassificationSystemVersionModel model = new ClassificationSystemVersionModel();
		model.setVersion(resourceId);
		return (ClassificationSystemVersionModel) readResourceInternal(model);
	}
	
	/**
	 * Convenience method which just delegates to {@link #setResourceValue(ClassificationSystemVersionModel)}
	 */
	public void setClassificationSystemVersionModel(final ClassificationSystemVersionModel value)
	{
