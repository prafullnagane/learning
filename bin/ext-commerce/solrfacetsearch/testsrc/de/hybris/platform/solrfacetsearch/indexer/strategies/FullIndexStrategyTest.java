...
public class FullIndexStrategyTest
{
	...
	public void setUp() throws IndexerException
	{
		...
		{
			@Override
			protected boolean performOperationOnIndex(
					final de.hybris.platform.solrfacetsearch.config.FlexibleSearchQuerySpec querySpec, final IndexConfig indexConfig,
