...
/**
 * Generated resource class for type SyncItemCronJob first defined at extension catalog
 */
@SuppressWarnings("all")
public class SyncItemCronJobResource extends AbstractYResource<SyncItemCronJobModel>
{
	/**
	 * <i>Generated constructor</i> - for generic creation.
	 */
	public SyncItemCronJobResource()
	{
	 ...
	 */
	@DELETE
	public Response deleteSyncItemCronJob()
	{
	 ...
	 */
	@GET
	public Response getSyncItemCronJob()
	{
	 ...
	 */
	public SyncItemCronJobModel getSyncItemCronJobModel()
	{
	 ...
	 */
	@PUT
	public Response putSyncItemCronJob(final SyncItemCronJobDTO dto)
	{
		return createPutResponse(dto).build();
	}
	
	/**
	 * Gets the {@link SyncItemCronJobModel} resource which is addressed by current resource request.
	 * @see de.hybris.platform.webservices.AbstractYResource#readResource(String)
	 */
	@Override
	protected SyncItemCronJobModel readResource(final String resourceId) throws Exception
	{
		SyncItemCronJobModel model = new SyncItemCronJobModel();
		model.setCode(resourceId);
		return (SyncItemCronJobModel) readResourceInternal(model);
	}
	
	/**
	 * Convenience method which just delegates to {@link #setResourceValue(SyncItemCronJobModel)}
	 */
	public void setSyncItemCronJobModel(final SyncItemCronJobModel value)
	{
