...
/**
 * Generated resource class for type ReplacementOrder first defined at extension basecommerce
 */
@SuppressWarnings("all")
public class ReplacementOrderResource extends AbstractYResource<ReplacementOrderModel>
{
	/**
	 * <i>Generated constructor</i> - for generic creation.
	 */
	public ReplacementOrderResource()
	{
	 ...
	 */
	@DELETE
	public Response deleteReplacementOrder()
	{
	 ...
	 */
	@GET
	public Response getReplacementOrder()
	{
	 ...
	 */
	public ReplacementOrderModel getReplacementOrderModel()
	{
	 ...
	 */
	@PUT
	public Response putReplacementOrder(final ReplacementOrderDTO dto)
	{
		return createPutResponse(dto).build();
	}
	
	/**
	 * Gets the {@link ReplacementOrderModel} resource which is addressed by current resource request.
	 * @see de.hybris.platform.webservices.AbstractYResource#readResource(String)
	 */
	@Override
	protected ReplacementOrderModel readResource(final String resourceId) throws Exception
	{
		ReplacementOrderModel model = new ReplacementOrderModel();
		model.setCode(resourceId);
		return (ReplacementOrderModel) readResourceInternal(model);
	}
	
	/**
	 * Convenience method which just delegates to {@link #setResourceValue(ReplacementOrderModel)}
	 */
	public void setReplacementOrderModel(final ReplacementOrderModel value)
	{
