...
public abstract class AbstractConstraintTest extends ServicelayerTransactionalTest
{
			...
			final Class interceptor)
	{
		...
		{
			final InterceptorException ie = (InterceptorException) exeption.getCause();
			assertEquals(interceptor, ie.getInterceptor().getClass());
		}
			...
			final Map<String, String> expectedConstraintViolations)
	{
		...
		final ValidationViolationException ve = (ValidationViolationException) cause;

		final Set<HybrisConstraintViolation> violations = ve.getHybrisConstraintViolations();
