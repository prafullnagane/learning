...
public class PLA_12639_Test extends HybrisJUnit4Test
{
	...
	{
		final TypeManager tm = jaloSession.getTypeManager();
		final ComposedType productType = tm.getComposedType(Product.class);
		...
		assertNotNull(product = pm.createProduct("ppp"));
