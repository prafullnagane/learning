...
/**
 * Generated resource class for type CMSPageType first defined at extension cms2
 */
@SuppressWarnings("all")
public class CMSPageTypeResource extends AbstractYResource<CMSPageTypeModel>
{
	/**
	 * <i>Generated constructor</i> - for generic creation.
	 */
	public CMSPageTypeResource()
	{
		super("CMSPageType");
	}
	 ...
	 */
	@DELETE
	public Response deleteCMSPageType()
	{
	 ...
	 */
	@GET
	public Response getCMSPageType()
	{
	 ...
	 */
	public CMSPageTypeModel getCMSPageTypeModel()
	{
	 ...
	 */
	@PUT
	public Response putCMSPageType(final CMSPageTypeDTO dto)
	{
		return createPutResponse(dto).build();
	}
	
	/**
	 * Gets the {@link CMSPageTypeModel} resource which is addressed by current resource request.
	 * @see de.hybris.platform.webservices.AbstractYResource#readResource(String)
	 */
	@Override
	protected CMSPageTypeModel readResource(final String resourceId) throws Exception
	{
		CMSPageTypeModel model = new CMSPageTypeModel();
		model.setCode(resourceId);
		return (CMSPageTypeModel) readResourceInternal(model);
	}
	
	/**
	 * Convenience method which just delegates to {@link #setResourceValue(CMSPageTypeModel)}
	 */
	public void setCMSPageTypeModel(final CMSPageTypeModel value)
	{
