...
public abstract class AbstractResource<RESOURCE> implements RestResource<RESOURCE>, CrudActionNotifable<RESOURCE>
{
	 ...
	 */
	protected void processException(final String msg, Exception e) throws WebApplicationException
	{
		...
		if (!(e instanceof YWebservicesException))
		{
			e = new YWebservicesException(msg, e);
		}

		// safe cast
		final YWebservicesException yWsException = (YWebservicesException) e;
		...
		throw new WebApplicationException(e, responseBuilder.build());
	}
