...
/**
 * Generated resource class for type ViewType first defined at extension core
 */
@SuppressWarnings("all")
public class ViewTypeResource extends AbstractYResource<ViewTypeModel>
{
	/**
	 ...
	 */
	public ViewTypeModel getViewTypeModel()
	{
	 ...
	 */
	@PUT
	public Response putViewType(final ViewTypeDTO dto)
	{
		return createPutResponse(dto).build();
	}
	
	/**
	 * Gets the {@link ViewTypeModel} resource which is addressed by current resource request.
	 * @see de.hybris.platform.webservices.AbstractYResource#readResource(String)
	 */
	@Override
	protected ViewTypeModel readResource(final String resourceId) throws Exception
	{
		ViewTypeModel model = new ViewTypeModel();
		model.setCode(resourceId);
		return (ViewTypeModel) readResourceInternal(model);
	}
	
	/**
	 * Convenience method which just delegates to {@link #setResourceValue(ViewTypeModel)}
	 */
	public void setViewTypeModel(final ViewTypeModel value)
	{
