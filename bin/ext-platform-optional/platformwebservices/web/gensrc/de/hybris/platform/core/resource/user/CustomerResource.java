...
/**
 * Generated resource class for type Customer first defined at extension core
 */
...
public class CustomerResource extends AbstractYResource<CustomerModel>
{
	 ...
	 */
	@PUT
	public Response putCustomer(final CustomerDTO dto)
	{
		return createPutResponse(dto).build();
	}
	
	/**
	 * Gets the {@link CustomerModel} resource which is addressed by current resource request.
	 * @see de.hybris.platform.webservices.AbstractYResource#readResource(String)
	 */
	@Override
	protected CustomerModel readResource(final String resourceId) throws Exception
	{
	...
	/**
	 * Convenience method which just delegates to {@link #setResourceValue(CustomerModel)}
	 */
	public void setCustomerModel(final CustomerModel value)
	{
