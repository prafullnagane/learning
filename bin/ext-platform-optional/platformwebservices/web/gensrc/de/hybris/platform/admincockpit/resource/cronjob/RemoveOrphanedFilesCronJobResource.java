...
/**
 * Generated resource class for type RemoveOrphanedFilesCronJob first defined at extension admincockpit
 */
@SuppressWarnings("all")
public class RemoveOrphanedFilesCronJobResource extends AbstractYResource<RemoveOrphanedFilesCronJobModel>
{
	/**
	 * <i>Generated constructor</i> - for generic creation.
	 */
	public RemoveOrphanedFilesCronJobResource()
	{
	 ...
	 */
	@DELETE
	public Response deleteRemoveOrphanedFilesCronJob()
	{
	 ...
	 */
	@GET
	public Response getRemoveOrphanedFilesCronJob()
	{
	 ...
	 */
	public RemoveOrphanedFilesCronJobModel getRemoveOrphanedFilesCronJobModel()
	{
	 ...
	 */
	@PUT
	public Response putRemoveOrphanedFilesCronJob(final RemoveOrphanedFilesCronJobDTO dto)
	{
		return createPutResponse(dto).build();
	}
	
	/**
	 * Gets the {@link RemoveOrphanedFilesCronJobModel} resource which is addressed by current resource request.
	 * @see de.hybris.platform.webservices.AbstractYResource#readResource(String)
	 */
	@Override
	protected RemoveOrphanedFilesCronJobModel readResource(final String resourceId) throws Exception
	{
		RemoveOrphanedFilesCronJobModel model = new RemoveOrphanedFilesCronJobModel();
		model.setCode(resourceId);
		return (RemoveOrphanedFilesCronJobModel) readResourceInternal(model);
	}
	
	/**
	 * Convenience method which just delegates to {@link #setResourceValue(RemoveOrphanedFilesCronJobModel)}
	 */
	public void setRemoveOrphanedFilesCronJobModel(final RemoveOrphanedFilesCronJobModel value)
	{
