...
import de.hybris.platform.addonsupport.constants.AddonsupportConstants;
 ...
 */
public class AddonsupportManager extends GeneratedAddonsupportManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(AddonsupportManager.class.getName());
	 ...
	 */
	public static AddonsupportManager getInstance()
	{
		return (AddonsupportManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				AddonsupportConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public AddonsupportManager() // NOPMD 
	{
