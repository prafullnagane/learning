...
/**
 * Generated resource class for type ConfigProxyMetaType first defined at extension core
 */
@SuppressWarnings("all")
public class ConfigProxyMetaTypeResource extends AbstractYResource<ConfigProxyMetaTypeModel>
{
	/**
	 * <i>Generated constructor</i> - for generic creation.
	 */
	public ConfigProxyMetaTypeResource()
	{
	 ...
	 */
	@DELETE
	public Response deleteConfigProxyMetaType()
	{
	 ...
	 */
	@GET
	public Response getConfigProxyMetaType()
	{
	 ...
	 */
	public ConfigProxyMetaTypeModel getConfigProxyMetaTypeModel()
	{
	 ...
	 */
	@PUT
	public Response putConfigProxyMetaType(final ConfigProxyMetaTypeDTO dto)
	{
		return createPutResponse(dto).build();
	}
	
	/**
	 * Gets the {@link ConfigProxyMetaTypeModel} resource which is addressed by current resource request.
	 * @see de.hybris.platform.webservices.AbstractYResource#readResource(String)
	 */
	@Override
	protected ConfigProxyMetaTypeModel readResource(final String resourceId) throws Exception
	{
		ConfigProxyMetaTypeModel model = new ConfigProxyMetaTypeModel();
		model.setCode(resourceId);
		return (ConfigProxyMetaTypeModel) readResourceInternal(model);
	}
	
	/**
	 * Convenience method which just delegates to {@link #setResourceValue(ConfigProxyMetaTypeModel)}
	 */
	public void setConfigProxyMetaTypeModel(final ConfigProxyMetaTypeModel value)
	{
