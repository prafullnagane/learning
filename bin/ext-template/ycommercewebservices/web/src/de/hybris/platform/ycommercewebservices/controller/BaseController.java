...
import de.hybris.platform.ycommercewebservices.dto.ErrorData;
import de.hybris.platform.ycommercewebservices.dto.ValidationErrorData;
...
public class BaseController
{
	...
	{ IllegalArgumentException.class, UnknownIdentifierException.class, AmbiguousIdentifierException.class,
			InconsistentUseridException.class, ModelSavingException.class, JaloInvalidParameterException.class,
			DuplicateUidException.class, PasswordMismatchException.class })
	...
	protected ValidationErrorData handleValidationErrorInternal(final String errorClass, final String errorMsg, final Errors errors)
	{
		...
		{
			final String validationError = createValidationError(error.getField(), getMessage(error.getCode(), currentLocale));
