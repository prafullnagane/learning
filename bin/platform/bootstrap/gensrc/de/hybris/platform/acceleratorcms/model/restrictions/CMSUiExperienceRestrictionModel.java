...
public class CMSUiExperienceRestrictionModel extends AbstractRestrictionModel
{
	 ...
	 * @param _uiExperience initial attribute declared by type <code>CMSUiExperienceRestriction</code> at extension <code>acceleratorcms</code>
	 * @param _uid initial attribute declared by type <code>CMSItem</code> at extension <code>cms2</code>
	 */
	@Deprecated
	public CMSUiExperienceRestrictionModel(final CatalogVersionModel _catalogVersion, final UiExperienceLevel _uiExperience, final String _uid)
	{
		super();
		setCatalogVersion(_catalogVersion);
		setUiExperience(_uiExperience);
		setUid(_uid);
	}
	 ...
	 */
	@Deprecated
	public CMSUiExperienceRestrictionModel(final CatalogVersionModel _catalogVersion, final ItemModel _owner, final UiExperienceLevel _uiExperience, final String _uid)
	{
		super();
		setCatalogVersion(_catalogVersion);
		setOwner(_owner);
