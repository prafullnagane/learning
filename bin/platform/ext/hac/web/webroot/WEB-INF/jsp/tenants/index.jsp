		...
		<div class="prepend-top" id="recent-reviews">
			...
			<div class="box">
				<div class="quiet">
					...
					Creating new tenants is possible only offline. See <a href="https://wiki.hybris.com/display/release5/Multi-Tenant+Systems">Multi-Tenant Systems document</a> for more information.</br></br>
			...
			<div class="box">
				<div class="quiet">
					...
					<ul>
						 <li> <a href="https://wiki.hybris.com/x/tAA_Cg" target="_blank" class="quiet">Spring in hybris Commerce Suite</a> </li> 
					</ul>
				</div>
			</div>		
		</div>
