	...
	<body>
			...
			<div class="span-6 last" id="sidebar1">
				<div class="prepend-top">
					...
					<div class="box">
						<ul>
							<li> <a href="https://wiki.hybris.com/display/release4/Database" target="_blank" class="quiet" >Third-Party Databases</a> </li>
						</ul>
					</div>
				</div>
			</div>	
			...
			<div class="span-6 last" id="sidebar3">
				<div class="prepend-top">
					...
					<div class="box">
						<ul>
							<li> <a href="https://wiki.hybris.com/display/release4/JDBC+Logging" target="_blank" class="quiet" >Logging Database Statements</a> </li>
						</ul>
					</div>
				</div>
			</div>		
