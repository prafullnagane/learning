...
@GraphNode(target = PromotionNullActionModel.class, factory = GenericNodeFactory.class, uidProperties="pk")
@XmlRootElement(name = "promotionnullaction")
public class PromotionNullActionDTO extends AbstractPromotionActionDTO
{
	/**
	 * <i>Generated constructor</i> - for generic creation.
	 */
	public PromotionNullActionDTO()
	{
		super();
	}
