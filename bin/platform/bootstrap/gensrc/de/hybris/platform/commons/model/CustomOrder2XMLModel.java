...
public class CustomOrder2XMLModel extends ItemFormatterModel
{
	 ...
	 */
	@Deprecated
	public CustomOrder2XMLModel(final CatalogVersionModel _catalogVersion, final String _code, final MediaFolderModel _folder, final String _outputMimeType, final ItemModel _owner)
	{
		super();
		setCatalogVersion(_catalogVersion);
		setCode(_code);
