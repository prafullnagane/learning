					...
					<table id="extensions" data-dependencyurl="<c:url value="/platform/extensions/dependency"/>">
						<thead>
							<tr>
								<th>Name</th>
								<th>Version</th>
								<th>core extension module</th>
								<th>hmc extension module</th>
								<th>Webroot</th>
							</tr>
						</thead>
						<tbody>
					      <c:forEach var="extension" items="${extensions}">
					        <tr>
					          <td title="${extension.properties}" class="extensionName pointer" data-extensionName="${extension.name}">${extension.name}</td>
			...
			<div class="span-6 last" id="sidebar">
				<div class="prepend-top" id="recent-reviews">
					...
					<div class="box">
						<div class="quiet">
							<ul>
							 <li> <a href="https://wiki.hybris.com/display/release4/hac_extensions" target="_blank" class="quiet">About Extensions</a> </li>
							</ul>  
						</div>
					</div>					
				</div>
