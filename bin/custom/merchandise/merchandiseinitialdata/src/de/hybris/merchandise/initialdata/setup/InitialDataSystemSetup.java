...
public class InitialDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		...
		if (getBooleanSystemSetupParameter(context, IMPORT_MERCHANDISE_DATA))
		{
			...
			importCommonData(context, "merchandiseinitialdata");
			importProductCatalog(context, "merchandiseinitialdata", "hybris");
			importContentCatalog(context, "merchandiseinitialdata", "hybris");
			importStoreLocations(context, "merchandiseinitialdata", "hybris");
