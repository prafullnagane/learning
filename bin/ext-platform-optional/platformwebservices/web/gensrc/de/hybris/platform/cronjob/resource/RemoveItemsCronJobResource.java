...
/**
 * Generated resource class for type RemoveItemsCronJob first defined at extension processing
 */
@SuppressWarnings("all")
public class RemoveItemsCronJobResource extends AbstractYResource<RemoveItemsCronJobModel>
{
	/**
	 * <i>Generated constructor</i> - for generic creation.
	 */
	public RemoveItemsCronJobResource()
	{
	 ...
	 */
	@DELETE
	public Response deleteRemoveItemsCronJob()
	{
	 ...
	 */
	@GET
	public Response getRemoveItemsCronJob()
	{
	 ...
	 */
	public RemoveItemsCronJobModel getRemoveItemsCronJobModel()
	{
	 ...
	 */
	@PUT
	public Response putRemoveItemsCronJob(final RemoveItemsCronJobDTO dto)
	{
		return createPutResponse(dto).build();
	}
	
	/**
	 * Gets the {@link RemoveItemsCronJobModel} resource which is addressed by current resource request.
	 * @see de.hybris.platform.webservices.AbstractYResource#readResource(String)
	 */
	@Override
	protected RemoveItemsCronJobModel readResource(final String resourceId) throws Exception
	{
		RemoveItemsCronJobModel model = new RemoveItemsCronJobModel();
		model.setCode(resourceId);
		return (RemoveItemsCronJobModel) readResourceInternal(model);
	}
	
	/**
	 * Convenience method which just delegates to {@link #setResourceValue(RemoveItemsCronJobModel)}
	 */
	public void setRemoveItemsCronJobModel(final RemoveItemsCronJobModel value)
	{
