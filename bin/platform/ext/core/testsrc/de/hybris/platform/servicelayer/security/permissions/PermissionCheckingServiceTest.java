...
public class PermissionCheckingServiceTest extends AbstractPermissionServiceTest
{
	...
	public void testExistingGroupHierarchyTraversal()
	{
		...
		final Principal principal = (Principal) modelService.getSource(testUser1);
		final UserRight right = (UserRight) modelService.getSource(getPermissionForName(TEST_PERMISSION_1));
	...
	public void testExistingTypeHierarchyTraversal()
	{
		...
		final ComposedType type = (ComposedType) modelService.getSource(classificationSystemType);
