...
public class DefaultProcessFactoryTest
{
	...
	public void setUp()
	{
		...
		beanFactory.registerBeanDefinition("DefaultProcessFactoryTest.processDefinitionFactoryTest", BeanDefinitionBuilder
				.rootBeanDefinition(DefaultProcessDefinitionFactory.class.getName()).getBeanDefinition());
