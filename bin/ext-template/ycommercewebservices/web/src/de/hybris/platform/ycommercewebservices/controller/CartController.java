...
public class CartController extends BaseController
{
	...
	/**
	 * Web service for getting session cart. If there is no cart in the current session, one will be created. <br>
	...
	@ResponseBody
	public CartData addPaymentInfo(final HttpServletRequest request) throws CustomValidationException, InvalidPaymentInfoException
	{
		if (LOG.isDebugEnabled())
		{
